---@class WorldMapSymbolsV1.WorldMapTextureSymbolV1 : zombie.worldMap.symbols.WorldMapSymbolsV1.WorldMapTextureSymbolV1
...
function WorldMapSymbolsV1_WorldMapTextureSymbolV1:init(arg0, arg1) end
