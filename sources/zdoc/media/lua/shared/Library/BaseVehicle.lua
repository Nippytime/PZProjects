...
---@field private lastLinearVelocity Vector3f
---@field public netPlayerAuthorization BaseVehicle.Authorization
...
---@field public previouslyEntered boolean
...
---@field limitPhysicPositionSent JVector2
---@field limitPhysicValid UpdateLimit
---@field private limitCrash UpdateLimit
...
---@field private physicReliableLimit UpdateLimit
---@field public isReliable boolean
