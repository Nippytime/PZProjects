...
---@field private mannequinScriptName String
---@field private modelScriptName String
---@field private textureName String
...
---@field private mannequinScript MannequinScript
---@field private modelScript ModelScript
...
---@private
---@return void
function IsoMannequin:initMannequinScript() end
...
---@private
---@return void
function IsoMannequin:initModelScript() end
...
---@private
---@return void
function IsoMannequin:getPropertiesFromZone() end
...
---@private
---@return void
function IsoMannequin:getPropertiesFromSprite() end
...
---@private
---@return void
function IsoMannequin:resetMannequin() end
