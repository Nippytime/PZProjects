   ...
   private void limitSound(GameSound var1, int var2) {
      ...
      if (var3 > var2) {
         ...
         for(var4 = 0; var4 < this.Instances.size(); ++var4) {
            ...
            if (var1.clips.contains(var5.clip)) {
               if (var5.clip.hasSustainPoints()) {
                  if (!var5.isTriggeredCue()) {
                     var5.triggerCue();
                  }
               } else {
                  var5.stop();
                  var5.release();
                  this.Instances.remove(var4--);
                  --var3;
                  if (var3 <= var2) {
                     return;
                  }
            ...
            if (var1.eventDescription == null) {
               ...
               if (var5 < 0L) {
                  ...
                  if (var1.hasMinDistance()) {
                     javafmodJNI.FMOD_Studio_EventInstance_SetProperty(var5, FMOD_STUDIO_EVENT_PROPERTY.FMOD_STUDIO_EVENT_PROPERTY_MINIMUM_DISTANCE.ordinal(), var1.getMinDistance());
                  }

                  if (var1.hasMaxDistance()) {
                     javafmodJNI.FMOD_Studio_EventInstance_SetProperty(var5, FMOD_STUDIO_EVENT_PROPERTY.FMOD_STUDIO_EVENT_PROPERTY_MAXIMUM_DISTANCE.ordinal(), var1.getMaxDistance());
                  }

                  FMODSoundEmitter.EventSound var7 = this.allocEventSound();
                  var7.clip = var1;
         ...
         if (!var1 && !javafmod.FMOD_Channel_IsPlaying(this.channel)) {
            ...
            if (this.clip.gameSound.is3D && (var3 != 0.0F || var4 != 0.0F)) {
               ...
               for(int var7 = 0; var7 < IsoPlayer.numPlayers; ++var7) {
                  ...
                  if (var8 != null && !var8.isDeaf()) {
                     var9 = IsoUtils.DistanceTo(var3, var4, var5 * 3.0F, var8.x, var8.y, var8.z * 3.0F);
                     var6 = PZMath.min(var6, var9);
                  }
               }

               float var15 = 2.0F;
               float var16 = var6 >= var15 ? 1.0F : 1.0F - (var15 - var6) / var15;
               javafmodJNI.FMOD_Channel_Set3DLevel(this.channel, var16);
               if (IsoPlayer.numPlayers > 1) {
                  ...
                  var15 = IsoUtils.DistanceManhatten(var3, var4, IsoPlayer.getInstance().x, IsoPlayer.getInstance().y, var5, IsoPlayer.getInstance().z) / var6;
                  IsoGridSquare var17 = IsoPlayer.getInstance().getCurrentSquare();
                  if (var17 == null) {
                     ...
                     if (var17.getRoom() == null) {
                        if (!this.ambient) {
                           var15 += IsoPlayer.getInstance().numNearbyBuildingsRooms / 32.0F;
                        }
                        ...
                        var9 = (float)var17.getRoom().Squares.size();
                        if (!this.ambient) {
                           var15 += var9 / 500.0F;
                        }
                     }
                     ...
                     var15 *= var15;
                     var15 *= var15;
                     var15 *= this.clip.reverbFactor;
                     var15 *= 10.0F;
                     if (IsoPlayer.getInstance().getCurrentSquare().getRoom() == null && var15 < 0.1F) {
                        var15 = 0.1F;
                     }
                     ...
                     javafmod.FMOD_Channel_SetReverbProperties(this.channel, var18, 0.0F);
                     ...
                     javafmod.FMOD_Channel_Set3DMinMaxDistance(this.channel, var2, this.clip.distanceMax);
                     IsoGridSquare var19 = IsoWorld.instance.CurrentCell.getGridSquare((double)var3, (double)var4, (double)var5);
                     float var20 = 0.0F;
                     float var22 = 0.0F;
                     IsoRoom var21;
                     if (var19 != null) {
                        if (!(this.emitter.parent instanceof IsoWindow) && !(this.emitter.parent instanceof IsoDoor)) {
                           if (var19.getRoom() != null) {
                              var21 = IsoPlayer.getInstance().getCurrentSquare().getRoom();
                              if (var21 == null) {
                                 var20 = 0.33F;
                                 var22 = 0.23F;
                              } else if (var21 != var19.getRoom()) {
                                 var20 = 0.24F;
                                 var22 = 0.24F;
                              }

                              if (var21 != null && var19.getRoom().getBuilding() != var21.getBuilding()) {
                                 var20 = 1.0F;
                                 var22 = 0.8F;
                              }

                              if (var21 != null && var19.getRoom().def.level != (int)IsoPlayer.getInstance().z) {
                                 var20 = 0.6F;
                                 var22 = 0.6F;
                              }
                           } else {
                           ...
                           var21 = IsoPlayer.getInstance().getCurrentSquare().getRoom();
                           if (var21 != this.emitter.parent.square.getRoom()) {
                              if (var21 != null && var21.getBuilding() == this.emitter.parent.square.getBuilding()) {
                                 var20 = 0.33F;
                                 var22 = 0.33F;
                              } else {
                                 ...
                                 if (this.emitter.parent instanceof IsoDoor) {
                                    ...
                                    IsoWindow var23 = (IsoWindow)this.emitter.parent;
                                    if (var23.north) {
                                       var13 = IsoWorld.instance.CurrentCell.getGridSquare((double)var23.getX(), (double)(var23.getY() - 1.0F), (double)var23.getZ());
                                    } else {
                                       var13 = IsoWorld.instance.CurrentCell.getGridSquare((double)(var23.getX() - 1.0F), (double)var23.getY(), (double)var23.getZ());
                                    }
                                 }

                                 if (var13 != null) {
                                    var21 = IsoPlayer.getInstance().getCurrentSquare().getRoom();
                                    if (var21 != null || var13.getRoom() == null) {
                                       if (var21 != null && var13.getRoom() != null && var21.building == var13.getBuilding()) {
                                          if (var21 != var13.getRoom()) {
                                             if (var21.def.level == var13.getZ()) {
                                                var20 = 0.33F;
                                                var22 = 0.33F;
                                             } else {
                                                var20 = 0.6F;
                        ...
                        if (!var19.isCouldSee(IsoPlayer.getPlayerIndex()) && var19 != IsoPlayer.getInstance().getCurrentSquare()) {
                           var20 += 0.4F;
                        }
                     } else {
                     ...
                     if (var19 != null && (int)IsoPlayer.getInstance().z != var19.getZ()) {
                        var20 *= 1.3F;
                     }
                     ...
                     if (this.emitter.emitterType == EmitterType.Footstep && var5 > IsoPlayer.getInstance().z && var19.getBuilding() == IsoPlayer.getInstance().getBuilding()) {
                        var20 = 0.0F;
                        var22 = 0.0F;
                     }
                     ...
                     javafmod.FMOD_Channel_Set3DOcclusion(this.channel, var20, var22);
                     javafmod.FMOD_Channel_SetVolume(this.channel, this.getVolume());
   ...
   private static final class EventSound extends FMODSoundEmitter.Sound {
      ...
      boolean tick(boolean var1) {
         ...
         if (!var1) {
            ...
            if (this.bTriggeredCue && FMODSoundEmitter.CurrentTimeMS - this.checkTimeMS > 250L && var3 == FMOD_STUDIO_PLAYBACK_STATE.FMOD_STUDIO_PLAYBACK_SUSTAINING.index) {
