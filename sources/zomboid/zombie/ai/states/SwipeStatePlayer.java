   ...
   public void ConnectSwing(IsoGameCharacter var1, HandWeapon var2) {
      ...
      if (!var7 && var10) {
         ...
         if (Rand.Next(var2.getConditionLowerChance() * var49 + var1.getMaintenanceMod() * 2) == 0) {
            var7 = true;
         } else if (Rand.NextBool(2) && WeaponType.getWeaponType(var1) != WeaponType.barehand && (!var2.isTwoHandWeapon() || var1.getPrimaryHandItem() == var2 || var1.getSecondaryHandItem() == var2 || !Rand.NextBool(3))) {
            var1.getXp().AddXP(PerkFactory.Perks.Maintenance, 1.0F);
         }
      }
