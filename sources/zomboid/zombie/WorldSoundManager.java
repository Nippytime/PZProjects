         ...
         if (!GameClient.bClient) {
            if (!GameServer.bServer || ServerGUI.isCreated()) {
               ...
               for(int var3 = 0; var3 < this.SoundList.size(); ++var3) {
                  ...
                  for(double var6 = 0.0D; var6 < 6.283185307179586D; var6 += 0.15707963267948966D) {
                     this.DrawIsoLine((float)var4.x + var5 * (float)Math.cos(var6), (float)var4.y + var5 * (float)Math.sin(var6), (float)var4.x + var5 * (float)Math.cos(var6 + 0.15707963267948966D), (float)var4.y + var5 * (float)Math.sin(var6 + 0.15707963267948966D), (float)var4.z, 1.0F, 1.0F, 1.0F, 1.0F, 1);
                  }
               }
                        ...
                        for(int var18 = 0; var18 < IsoChunkMap.ChunkGridWidth; ++var18) {
                           ...
                           if (var19 != null) {
                              for(int var7 = 0; var7 < var19.SoundList.size(); ++var7) {
                                 WorldSoundManager.WorldSound var8 = (WorldSoundManager.WorldSound)var19.SoundList.get(var7);
                                 float var9 = (float)var8.radius * var2;

                                 for(double var10 = 0.0D; var10 < 6.283185307179586D; var10 += 0.15707963267948966D) {
                                    this.DrawIsoLine((float)var8.x + var9 * (float)Math.cos(var10), (float)var8.y + var9 * (float)Math.sin(var10), (float)var8.x + var9 * (float)Math.cos(var10 + 0.15707963267948966D), (float)var8.y + var9 * (float)Math.sin(var10 + 0.15707963267948966D), (float)var8.z, 0.0F, 1.0F, 1.0F, 1.0F, 1);
