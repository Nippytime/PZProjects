...
public class RCONClient {
   ...
   public boolean auth(String var1) {
      try {
         ...
         RCONClient.RCONMessage var3 = new RCONClient.RCONMessage(var2, 3, var1);
         var3.writeObject(this.socket.getOutputStream());
         RCONClient.RCONMessage var4 = new RCONClient.RCONMessage();
         var4.readObject(this.socket.getInputStream(), 14);
         if (var4.type == 0 && var4.id == var2) {
            RCONClient.RCONMessage var5 = new RCONClient.RCONMessage();
   ...
   public String exec(String var1) {
      try {
         int var2 = (int)(65535L & System.currentTimeMillis());
         RCONClient.RCONMessage var3 = new RCONClient.RCONMessage(var2, 2, var1);
         var3.writeObject(this.socket.getOutputStream());
         RCONClient.RCONMessage var4 = new RCONClient.RCONMessage();
