...
public class MPStatistics {
   ...
   private static void getClientStatistics() {
      try {
         ...
         clientCPULoad = (long)(((OperatingSystemMXBean)ManagementFactory.getOperatingSystemMXBean()).getProcessCpuLoad() * 100.0D);
   ...
   private static void getServerStatistics() {
      try {
         ...
         serverCPULoad = (long)(((OperatingSystemMXBean)ManagementFactory.getOperatingSystemMXBean()).getProcessCpuLoad() * 100.0D);
   ...
   private static Object $deserializeLambda$(SerializedLambda var0) {
      ...
      case 108861471:
         if (var1.equals("lambda$Init$93733d2f$1")) {
            var2 = 0;
         }
      default:
         switch(var2) {
         case 0:
            if (var0.getImplMethodKind() == 6 && var0.getFunctionalInterfaceClass().equals("javax/management/NotificationFilter") && var0.getFunctionalInterfaceMethodName().equals("isNotificationEnabled") && var0.getFunctionalInterfaceMethodSignature().equals("(Ljavax/management/Notification;)Z") && var0.getImplClass().equals("zombie/network/MPStatistics") && var0.getImplMethodSignature().equals("(Ljavax/management/Notification;)Z")) {
               return (var0x) -> {
                  return "java.management.memory.threshold.exceeded".equals(var0x.getType());
               };
            }
