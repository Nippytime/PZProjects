...
public class PacketValidator {
   ...
   public String getDescription() {
      ...
      if (GameServer.bServer) {
         Set var2 = (Set)this.details.entrySet().stream().filter((var1x) -> {
            return this.detailsFromClient.get(var1x.getKey()) != null && ((PacketValidator.RecipeDetails)this.detailsFromClient.get(var1x.getKey())).crc == ((PacketValidator.RecipeDetails)var1x.getValue()).crc;
   ...
   public static class RecipeDetails {
      ...
      public RecipeDetails(String var1, long var2, int var4, ArrayList var5, ArrayList var6, String var7, String var8, int var9) {
         this.name = var1;
         this.crc = var2;
         ...
         if (var5 != null) {
            ...
            while(var10.hasNext()) {
               ...
               this.skills.add(new PacketValidator.RecipeDetails.Skill(var11.getPerk().getName(), var11.getLevel()));
            }
         }
      ...
      public RecipeDetails(ByteBuffer var1) {
         ...
         for(int var4 = 0; var4 < var3; ++var4) {
            this.skills.add(new PacketValidator.RecipeDetails.Skill(GameWindow.ReadString(var1), var1.getInt()));
         }
      ...
      public void write(ByteBufferWriter var1) {
         ...
         while(var2.hasNext()) {
            PacketValidator.RecipeDetails.Skill var4 = (PacketValidator.RecipeDetails.Skill)var2.next();
