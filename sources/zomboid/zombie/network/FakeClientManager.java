...
public class FakeClientManager {
   ...
   public static void main(String[] var0) {
      ...
      if (var2 != -1) {
         var5 = 17500 + var2;
         var4 = new FakeClientManager.Network(var11.size(), var5);
      } else {
         var5 = 17500;
         var4 = new FakeClientManager.Network(var11.size(), var5);
      }
      ...
      if (var4.isStarted()) {
         int var6 = 0;
         if (var2 != -1) {
            FakeClientManager.Movement var12 = (FakeClientManager.Movement)var11.get(var2);
            if (var12 != null) {
               players.add(new FakeClientManager.Player(var12, var4, var6, var5));
            } else {
               error(var2, "Client movement not found");
            }
         } else {
            Iterator var7 = var11.values().iterator();

            while(var7.hasNext()) {
               FakeClientManager.Movement var8 = (FakeClientManager.Movement)var7.next();
               players.add(new FakeClientManager.Player(var8, var4, var6++, var5));
            }
         }
   ...
   private static class Network {
      ...
      private static void logUserPacket(int var0, short var1) {
         PacketTypes.PacketType var2 = (PacketTypes.PacketType)PacketTypes.packetTypes.get(var1);
      ...
      private void decode(ByteBuffer var1) {
         ...
         case 16:
            ...
            var6 = (FakeClientManager.Client)this.createdClients.get(var8);
            if (var6 != null) {
            ...
            FakeClientManager.log(-1, String.format("Connected clients: %d (connection index %d)", this.connectedClients.size(), var8));
            break;
         case 17:
         case 18:
         case 23:
