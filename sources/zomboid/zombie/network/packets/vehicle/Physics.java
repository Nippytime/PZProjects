...
public class Physics extends VehicleInterpolationData implements INetworkPacket {
   ...
   public boolean set(BaseVehicle var1) {
      if (Bullet.getOwnVehiclePhysics(var1.VehicleID, buffer) != 0) {
         ...
         this.wheelsCount = (short)((int)buffer[var4++]);

         for(int var3 = 0; var3 < this.wheelsCount; ++var3) {
            this.wheelSteering[var3] = buffer[var4++];
            this.wheelRotation[var3] = buffer[var4++];
            this.wheelSkidInfo[var3] = buffer[var4++];
            this.wheelSuspensionLength[var3] = buffer[var4++];
         }
