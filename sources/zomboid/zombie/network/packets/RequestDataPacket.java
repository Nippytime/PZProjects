...
public class RequestDataPacket implements INetworkPacket {
   ...
   public void setRequest(RequestDataPacket.RequestID var1) {
      this.type = RequestDataPacket.RequestType.Request;
      this.id = var1;
   }

   public void setPartData(RequestDataPacket.RequestID var1, ByteBuffer var2) {
   ...
   public void setACK(RequestDataPacket.RequestID var1) {
   ...
   private void sendNextRequest(RequestDataPacket.RequestID var1) {
      switch(var1) {
      case Descriptors:
