...
public final class NetChecksum {
   ...
   public static final class Checksummer {
      ...
      public String toString() {
         ...
         while(var2.hasNext()) {
            NetChecksum.GroupOfFiles var3 = (NetChecksum.GroupOfFiles)var2.next();
      ...
      public void serverPacket(ByteBuffer var1, UdpConnection var2) {
         if (GameServer.bServer) {
            ...
            case 3:
               ...
               NetChecksum.GroupOfFiles var6 = (NetChecksum.GroupOfFiles)NetChecksum.GroupOfFiles.groups.get(var11);
