...
public class ServerMap {
   ...
   public final IsoObjectID ZombieMap = new IsoObjectID(IsoZombie.class);
   ...
   public void setSoftResetChunk(IsoChunk var1) {
      ...
      if (this.isValidCell(var2, var3)) {
         ServerMap.ServerCell var4 = this.getCell(var2, var3);
         if (var4 == null) {
            var4 = new ServerMap.ServerCell();
            var4.bLoaded = true;
