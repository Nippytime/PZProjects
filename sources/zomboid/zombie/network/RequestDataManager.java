...
public class RequestDataManager {
   ...
   public void ACKWasReceived(RequestDataPacket.RequestID var1, UdpConnection var2, int var3) {
      RequestDataManager.RequestData var4 = null;

      for(int var5 = 0; var5 <= this.requests.size(); ++var5) {
         if (((RequestDataManager.RequestData)this.requests.get(var5)).connectionGUID == var2.getConnectedGUID()) {
            var4 = (RequestDataManager.RequestData)this.requests.get(var5);
            break;
         }
      }
   ...
   public void putDataForTransmit(RequestDataPacket.RequestID var1, UdpConnection var2, ByteBuffer var3) {
      RequestDataManager.RequestData var4 = new RequestDataManager.RequestData(var1, var3, var2.getConnectedGUID());
   ...
   private void sendData(RequestDataManager.RequestData var1) {
   ...
   public ByteBuffer receiveClientData(RequestDataPacket.RequestID var1, ByteBuffer var2, int var3, int var4) {
      RequestDataManager.RequestData var5 = null;

      for(int var6 = 0; var6 < this.requests.size(); ++var6) {
         if (((RequestDataManager.RequestData)this.requests.get(var6)).id == var1) {
            var5 = (RequestDataManager.RequestData)this.requests.get(var6);
            break;
         }
      }

      if (var5 == null) {
         var5 = new RequestDataManager.RequestData(var1, var3, 0L);
