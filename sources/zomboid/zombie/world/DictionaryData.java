...
public class DictionaryData {
   ...
   protected void createErrorBackups() {
      if (!Core.getInstance().isNoSave()) {
         try {
            ...
            String var10000 = ZomboidFileSystem.instance.getFileNameInCurrentSave("WD_ERROR_" + var1);
            String var3 = var10000 + File.separator;
            ...
            var6 = new File(ZomboidFileSystem.instance.getFileNameInCurrentSave("WorldDictionaryLog.lua"));
   ...
   protected void saveAsText(String var1) throws IOException, WorldDictionaryException {
      if (!Core.getInstance().isNoSave()) {
         ...
         File var2 = new File(var10002 + File.separator);
