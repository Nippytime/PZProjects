            ...
            if (var1 == null) {
               ...
               if (!ZomboidRadio.DISABLE_BROADCASTING) {
                  ...
                  if (this.louisvilleObfuscate && ZomboidRadio.LOUISVILLE_OBFUSCATION) {
                     ...
                     ZomboidRadio.getInstance().SendTransmission(0, 0, this.frequency, var2, (String)null, "", 0.7F, 0.5F, 0.5F, -1, this.isTv);
                  } else {
                     ZomboidRadio.getInstance().SendTransmission(0, 0, this.frequency, var2, (String)null, var1.getEffectsString(), var1.getR(), var1.getG(), var1.getB(), -1, this.isTv);
                  }
               }
