      ...
      for(int var7 = var3; var7 < var5; ++var7) {
         for(int var8 = var4; var8 < var6; ++var8) {
            ...
            if (var9 != null) {
               ...
               for(var10 = var9.getSpecialObjects().size() - 1; var10 >= 0; --var10) {
                  var11 = (IsoObject)var9.getSpecialObjects().get(var10);
                  var9.RemoveTileObject(var11);
               }

               for(var10 = var9.getStaticMovingObjects().size() - 1; var10 >= 0; --var10) {
                  IsoDeadBody var12 = (IsoDeadBody)Type.tryCastTo((IsoMovingObject)var9.getStaticMovingObjects().get(var10), IsoDeadBody.class);
                  if (var12 != null) {
                     var9.removeCorpse(var12, false);
                  }
               }
