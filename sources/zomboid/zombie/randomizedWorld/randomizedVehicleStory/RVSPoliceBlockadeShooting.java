      ...
      if (var3 != null) {
         ...
         case 0:
            ...
            if (this.horizontalZone) {
               ...
               var17 = (int)(var2.position.y + var2.width / 2.0F) - 1;
               var19 = (int)var2.position.x;

               for(var12 = var14; var12 <= var17; ++var12) {
                  var13 = IsoCell.getInstance().getGridSquare(var19, var12, var5.z);
                  if (var13 != null) {
                     if (var12 != var14 && var12 != var17) {
               ...
               var17 = (int)(var2.position.x + var2.width / 2.0F) - 1;
               var19 = (int)var2.position.y;
         ...
         case 1:
            ...
            if (var9 != null) {
               ...
               IsoDirections var16 = this.horizontalZone ? (var2.position.x < var9.x ? IsoDirections.W : IsoDirections.E) : (var2.position.y < var9.y ? IsoDirections.N : IsoDirections.S);
               float var18 = var16.ToVector().getDirection();
               this.addTrailOfBlood(var2.position.x, var2.position.y, var2.z, var18, 5);
            }
            break;
         case 2:
         case 3:
