...
public final class Nutrition {
   ...
   private void updateWeight() {
      ...
      float var4 = (float)((this.getWeight() - 80.0D) * 40.0D);
      var1 = 1600.0F + var4;
      var3 = (float)((this.getWeight() - 70.0D) * 30.0D);
      if (var3 > 0.0F) {
         var3 = 0.0F;
      }
   ...
   public void load(ByteBuffer var1) {
      ...
      this.setWeight((double)var1.getFloat());
   }
   ...
   public void applyTraitFromWeight() {
      ...
      if (this.getWeight() >= 100.0D) {
         this.parent.getTraits().add("Obese");
      }

      if (this.getWeight() >= 85.0D && this.getWeight() < 100.0D) {
         this.parent.getTraits().add("Overweight");
      }

      if (this.getWeight() > 65.0D && this.getWeight() <= 75.0D) {
         this.parent.getTraits().add("Underweight");
      }

      if (this.getWeight() > 50.0D && this.getWeight() <= 65.0D) {
         this.parent.getTraits().add("Very Underweight");
      }

      if (this.getWeight() <= 50.0D) {
