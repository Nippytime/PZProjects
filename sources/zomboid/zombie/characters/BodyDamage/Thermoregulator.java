...
public final class Thermoregulator {
   ...
   public void save(ByteBuffer var1) throws IOException {
      ...
      for(int var3 = 0; var3 < this.nodes.length; ++var3) {
         Thermoregulator.ThermalNode var2 = this.nodes[var3];
   ...
   public void load(ByteBuffer var1, int var2) throws IOException {
      ...
      for(int var5 = 0; var5 < var3; ++var5) {
         ...
         Thermoregulator.ThermalNode var4 = this.getNodeForType(BodyPartType.FromIndex(var6));
         if (var4 != null) {
            var4.celcius = var7;
   ...
   public void reset() {
      ...
      for(int var2 = 0; var2 < this.nodes.length; ++var2) {
         Thermoregulator.ThermalNode var1 = this.nodes[var2];
         if (var1 != this.core) {
            var1.celcius = 35.0F;
         }
   ...
   private void initNodes() {
      ...
      for(var2 = 0; var2 < this.bodyDamage.getBodyParts().size(); ++var2) {
         ...
         Thermoregulator.ThermalNode var4 = null;
         switch(var3.getType()) {
         case Torso_Upper:
            var4 = new Thermoregulator.ThermalNode(true, 37.0F, var3, 0.25F);
            this.core = var4;
            break;
         case Head:
            var4 = new Thermoregulator.ThermalNode(37.0F, var3, 1.0F);
            break;
         case Neck:
            var4 = new Thermoregulator.ThermalNode(37.0F, var3, 0.5F);
            break;
         case Torso_Lower:
            var4 = new Thermoregulator.ThermalNode(37.0F, var3, 0.25F);
            break;
         case Groin:
            var4 = new Thermoregulator.ThermalNode(37.0F, var3, 0.5F);
            break;
      ...
      this.nodes = new Thermoregulator.ThermalNode[var1.size()];
      var1.toArray(this.nodes);

      for(var2 = 0; var2 < this.nodes.length; ++var2) {
         Thermoregulator.ThermalNode var7 = this.nodes[var2];
         ...
         if (var5 != null && var5.length > 0) {
            var7.downstream = new Thermoregulator.ThermalNode[var5.length];
   ...
   public Thermoregulator.ThermalNode getNode(int var1) {
      return this.nodes[var1];
   }

   public Thermoregulator.ThermalNode getNodeForType(BodyPartType var1) {
      for(int var2 = 0; var2 < this.nodes.length; ++var2) {
   ...
   public Thermoregulator.ThermalNode getNodeForBloodType(BloodBodyPartType var1) {
      for(int var2 = 0; var2 < this.nodes.length; ++var2) {
   ...
   public float getTimedActionTimeModifier() {
      ...
      for(int var4 = 0; var4 < this.nodes.length; ++var4) {
         Thermoregulator.ThermalNode var3 = this.nodes[var4];
         float var5 = 0.0F;
   ...
   private float getSimulationMultiplier(Thermoregulator.Multiplier var1) {
   ...
   private void updateSetPoint() {
      ...
      if (this.stats.getSickness() > 0.0F) {
         float var1 = 2.0F;
         this.setPoint += this.stats.getSickness() * var1;
      }
   ...
   private void updateMetabolicRate() {
      ...
      if (!PZMath.equal(this.metabolicRate, this.metabolicTarget)) {
         ...
         if (this.metabolicTarget > this.metabolicRate) {
            this.metabolicRate += var4 * this.getSimulationMultiplier(Thermoregulator.Multiplier.MetabolicRateInc);
         } else {
            this.metabolicRate += var4 * this.getSimulationMultiplier(Thermoregulator.Multiplier.MetabolicRateDec);
         }
      }
   ...
   private void updateNodesHeatDelta() {
      float var1 = PZMath.clamp_01((float)((this.player.getNutrition().getWeight() / 75.0D - 0.5D) * 0.6660000085830688D));
      var1 = (var1 - 0.5F) * 2.0F;
      ...
      for(int var8 = 0; var8 < this.nodes.length; ++var8) {
         Thermoregulator.ThermalNode var7 = this.nodes[var8];
         ...
         if (var7.primaryDelta > 0.0F) {
            ...
            var11 = Metabolics.Default.getMet() * var7.primaryDelta * var7.skinSurface / (1.0F + var7.insulation);
         ...
         if (var7.secondaryDelta > 0.0F) {
            ...
            var11 = Metabolics.MAX.getMet() * 0.75F * var7.secondaryDelta * var7.skinSurface / (1.0F + var7.insulation);
            var11 *= var12;
   ...
   private void updateHeatDeltas() {
      ...
      Thermoregulator.ThermalNode var10000 = this.core;
   ...
   private void updateNodes() {
      ...
      for(int var4 = 0; var4 < this.nodes.length; ++var4) {
         Thermoregulator.ThermalNode var1 = this.nodes[var4];
         ...
         var11 = this.getSimulationMultiplier(Thermoregulator.Multiplier.SkinCelcius);
   ...
   private void updateBodyMultipliers() {
      ...
      if (this.primTotal < 0.0F) {
         this.energyMultiplier += (double)(0.05F * var1);
         this.fatigueMultiplier += (double)(0.25F * var1);
      } else if (this.primTotal > 0.0F) {
         this.fluidsMultiplier += (double)(0.25F * var1);
         this.fatigueMultiplier += (double)(0.25F * var1);
      }
      ...
      if (this.secTotal < 0.0F) {
         this.energyMultiplier += (double)(0.1F * var1);
         this.fatigueMultiplier += (double)(0.75F * var1);
      } else if (this.secTotal > 0.0F) {
         this.fluidsMultiplier += (double)(3.75F * var1);
         this.fatigueMultiplier += (double)(1.75F * var1);
      }
