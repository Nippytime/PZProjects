...
public final class ZombieVocalsManager {
   ...
   public ZombieVocalsManager() {
      byte var1 = 20;
      this.m_slots = (ZombieVocalsManager.Slot[])PZArrayUtil.newInstance(ZombieVocalsManager.Slot.class, var1, ZombieVocalsManager.Slot::new);
   }

   public void addCharacter(IsoZombie var1) {
      if (!this.m_added.contains(var1)) {
         this.m_added.add(var1);
         ZombieVocalsManager.ObjectWithDistance var2 = (ZombieVocalsManager.ObjectWithDistance)this.m_objectPool.alloc();
         var2.character = var1;
         ...
         if (var1 - this.m_updateMS >= 500L) {
            ...
            if (this.m_objects.isEmpty()) {
               ...
               for(var3 = 0; var3 < this.m_objects.size(); ++var3) {
                  ZombieVocalsManager.ObjectWithDistance var4 = (ZombieVocalsManager.ObjectWithDistance)this.m_objects.get(var3);
                  var5 = var4.character;
               ...
               for(var7 = 0; var7 < var3; ++var7) {
                  var5 = ((ZombieVocalsManager.ObjectWithDistance)this.m_objects.get(var7)).character;
   ...
   void stopNotPlaying() {
      for(int var1 = 0; var1 < this.m_slots.length; ++var1) {
         ZombieVocalsManager.Slot var2 = this.m_slots[var1];
         if (!var2.playing) {
            var2.stopPlaying();
            var2.character = null;
         }
