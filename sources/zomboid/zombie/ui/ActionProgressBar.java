      ...
      if (this.isVisible() && UIManager.VisibleAllUI) {
         ...
         if (this.deltaValue == Float.POSITIVE_INFINITY) {
            if (this.animationProgress < 0.5F) {
               this.DrawUVSliceTexture(this.foreground, 3.0D, 0.0D, (double)this.foreground.getWidth(), (double)this.foreground.getHeight(), Color.white, 0.0D, 0.0D, (double)(this.animationProgress * 2.0F), 1.0D);
            } else {
               this.DrawUVSliceTexture(this.foreground, 3.0D, 0.0D, (double)this.foreground.getWidth(), (double)this.foreground.getHeight(), Color.white, (double)((this.animationProgress - 0.5F) * 2.0F), 0.0D, 1.0D, 1.0D);
            }
         } else {
