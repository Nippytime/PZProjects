      ...
      if (this.isVisible()) {
         if (this.Parent == null || this.Parent.maxDrawHeight == -1 || !((double)this.Parent.maxDrawHeight <= this.y)) {
            ...
            if (this.bClearButton && this.clearButtonTexture != null && !this.Lines.isEmpty()) {
               ...
               this.DrawTexture(this.clearButtonTexture, (double)(this.width - (float)var2 - 2.0F - (float)this.clearButtonTexture.getWidth()), (double)(var2 + (var1 - this.clearButtonTexture.getHeight()) / 2), (double)(var4 * this.clearButtonTransition.fraction() + 0.35F * (1.0F - this.clearButtonTransition.fraction())));
            }

            Double var19 = this.clampToParentX((double)(this.getAbsoluteX().intValue() + var2));
            ...
            this.setStencilRect((double)(var19.intValue() - this.getAbsoluteX().intValue()), (double)(var6.intValue() - this.getAbsoluteY().intValue()), (double)(var5.intValue() - var19.intValue()), (double)(var7.intValue() - var6.intValue()));
            int var9;
                  ...
                  if (this.Lines.get(var9) != null) {
                     if (var9 >= 0 && var9 < this.HighlightLines.length) {
                        if (this.HighlightLines[var9] == 1) {
                           this.DrawTextureScaledCol((Texture)null, (double)(var2 - 1), (double)var8, (double)(this.getWidth().intValue() - var2 * 2 + 2), (double)var1, this.NuetralColour);
                        } else if (this.HighlightLines[var9] == 2) {
                           this.DrawTextureScaledCol((Texture)null, (double)(var2 - 1), (double)var8, (double)(this.getWidth().intValue() - var2 * 2 + 2), (double)var1, this.NuetralColour2);
                        } else if (this.HighlightLines[var9] == 3) {
                           this.DrawTextureScaledCol((Texture)null, (double)(var2 - 1), (double)var8, (double)(this.getWidth().intValue() - var2 * 2 + 2), (double)var1, this.BadColour);
                        } else if (this.HighlightLines[var9] == 4) {
                           this.DrawTextureScaledCol((Texture)null, (double)(var2 - 1), (double)var8, (double)(this.getWidth().intValue() - var2 * 2 + 2), (double)var1, this.GoodColour);
                        }
                     }
            ...
            if (this.DoingTextEntry) {
               ...
               if (this.BlinkState) {
                  var9 = 0;
                  if (this.Lines.size() > 0) {
                     var21 = this.TextEntryCursorPos - this.TextOffsetOfLineStart.get(this.CursorLine);
                     var21 = Math.min(var21, ((String)this.Lines.get(this.CursorLine)).length());
                     var9 = var20.getWidth((String)this.Lines.get(this.CursorLine), 0, var21 - 1, true);
                     if (var9 > 0) {
                        --var9;
                     }
                  }

                  this.DrawTextureScaledCol(Texture.getWhite(), (double)(-this.XOffset + var2 + var9), (double)(var2 + this.CursorLine * var1), 1.0D, (double)var1, this.TextEntryCursorColour);
               }
               ...
               if (this.Lines.size() > 0 && this.ToSelectionIndex != this.TextEntryCursorPos) {
                  ...
                  var21 = Math.max(this.TextEntryCursorPos, this.ToSelectionIndex);
                  int var11 = this.toDisplayLine(var9);
                  int var12 = this.toDisplayLine(var21);
                  ...
                  for(int var13 = var11; var13 <= var12; ++var13) {
                     ...
                     this.DrawTextureScaledCol((Texture)null, (double)(-this.XOffset + var2 + var17), (double)(var2 + var13 * var1), (double)(var18 - var17), (double)var1, this.TextEntryCursorColour2);
                  }
               }
            }
            ...
            if (StencilLevel > 0) {
               this.repaintStencilRect((double)(var19.intValue() - this.getAbsoluteX().intValue()), (double)(var6.intValue() - this.getAbsoluteY().intValue()), (double)(var5.intValue() - var19.intValue()), (double)(var7.intValue() - var6.intValue()));
            }
   ...
   public void setCursorPos(int var1) {
      if (this.multipleLine) {
         if (this.CursorLine >= 0 && this.CursorLine < this.Lines.size()) {
            this.TextEntryCursorPos = PZMath.clamp(var1, 0, ((String)this.Lines.get(this.CursorLine)).length());
         }
      } else {
