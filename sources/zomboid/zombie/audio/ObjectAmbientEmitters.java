...
public final class ObjectAmbientEmitters {
   ...
   private ObjectAmbientEmitters() {
      byte var1 = 16;
      this.m_slots = (ObjectAmbientEmitters.Slot[])PZArrayUtil.newInstance(ObjectAmbientEmitters.Slot.class, var1, ObjectAmbientEmitters.Slot::new);
   ...
   private void addObject(IsoObject var1, ObjectAmbientEmitters.PerObjectLogic var2) {
         ...
         if (!this.m_added.containsKey(var1)) {
            ...
            for(int var4 = 0; var4 < IsoPlayer.numPlayers; ++var4) {
               ...
               if (var5 != null && var1.getObjectIndex() != -1) {
                  byte var6 = 15;
                  if (var2 instanceof ObjectAmbientEmitters.DoorLogic || var2 instanceof ObjectAmbientEmitters.WindowLogic) {
                     var6 = 10;
                  }

                  if ((var1.square.z == PZMath.fastfloor(var5.getZ()) || !(var2 instanceof ObjectAmbientEmitters.DoorLogic) && !(var2 instanceof ObjectAmbientEmitters.WindowLogic)) && !(var5.DistToSquared((float)var1.square.x + 0.5F, (float)var1.square.y + 0.5F) > (float)(var6 * var6))) {
                     var3 = true;
                     break;
                  }
               }
            ...
            if (var3) {
               ObjectAmbientEmitters.ObjectWithDistance var7 = (ObjectAmbientEmitters.ObjectWithDistance)this.m_objectPool.alloc();
               var7.object = var1;
               var7.logic = var2;
   ...
   void removeObject(IsoObject var1) {
      if (!GameServer.bServer) {
         ObjectAmbientEmitters.ObjectWithDistance var2 = (ObjectAmbientEmitters.ObjectWithDistance)this.m_added.remove(var1);
         if (var2 != null) {
   ...
   public void update() {
      if (!GameServer.bServer) {
         ...
         if (this.m_objects.isEmpty()) {
            ...
            IsoObject var3;
            ObjectAmbientEmitters.PerObjectLogic var4;
            for(var1 = 0; var1 < this.m_objects.size(); ++var1) {
               ObjectAmbientEmitters.ObjectWithDistance var2 = (ObjectAmbientEmitters.ObjectWithDistance)this.m_objects.get(var1);
               var3 = var2.object;
               var4 = ((ObjectAmbientEmitters.ObjectWithDistance)this.m_objects.get(var1)).logic;
            ...
            for(var6 = 0; var6 < var1; ++var6) {
               var3 = ((ObjectAmbientEmitters.ObjectWithDistance)this.m_objects.get(var6)).object;
               var4 = ((ObjectAmbientEmitters.ObjectWithDistance)this.m_objects.get(var6)).logic;
               if (this.shouldPlay(var3, var4)) {
               ...
               for(int var6 = -1; var6 <= 1; ++var6) {
                  ...
                  if (var7 != null) {
                     ...
                     while(var9.hasNext()) {
                        ...
                        this.addObject(var10, (ObjectAmbientEmitters.PerObjectLogic)var7.m_objectEmitterData.m_objects.get(var10));
                     }
                  }
               }
            }
   ...
   boolean shouldPlay(IsoObject var1, ObjectAmbientEmitters.PerObjectLogic var2) {
      if (var1 == null) {
         return false;
      } else {
   ...
   void stopNotPlaying() {
      for(int var1 = 0; var1 < this.m_slots.length; ++var1) {
         ObjectAmbientEmitters.Slot var2 = this.m_slots[var1];
         if (!var2.playing) {
            var2.stopPlaying();
            var2.object = null;
         }
   ...
   public void render() {
      if (DebugOptions.instance.ObjectAmbientEmitterRender.getValue()) {
         ...
         for(var2 = 0; var2 < this.m_slots.length; ++var2) {
            ObjectAmbientEmitters.Slot var13 = this.m_slots[var2];
            if (var13.playing) {
   ...
   static final class Slot {
      ...
      void playSound(IsoObject var1, ObjectAmbientEmitters.PerObjectLogic var2) {
   ...
   public static final class ChunkData {
      ...
      public void addObject(IsoObject var1, ObjectAmbientEmitters.PerObjectLogic var2) {
   ...
   public static final class AmbientSoundLogic extends ObjectAmbientEmitters.PerObjectLogic {
      ...
      public ObjectAmbientEmitters.PerObjectLogic init(IsoObject var1) {
         ...
         this.powerPolicy = (ObjectAmbientEmitters.PowerPolicy)ObjectAmbientEmitters.getInstance().powerPolicyMap.getOrDefault(var2, ObjectAmbientEmitters.PowerPolicy.NotRequired);
