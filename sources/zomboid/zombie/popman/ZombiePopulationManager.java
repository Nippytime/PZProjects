      ...
      if (!this.bClient) {
         if (var1.radius >= 50) {
            if (!var1.sourceIsZombie) {
               ...
               n_worldSound(var1.x, var1.y, (int)PZMath.ceil((float)var1.radius * var4), var1.volume);
            }
         }
      }
   }
   ...
   public void sitAgainstWall(IsoZombie var1, IsoGridSquare var2) {
      ...
      if (var5 != 0) {
         ...
         if (GameClient.bClient) {
            ...
            var6 = (IsoDirections)this.m_sittingDirections.get(var7 % this.m_sittingDirections.size());
         }
