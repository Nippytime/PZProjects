...
public final class BaseVehicle extends IsoMovingObject implements Thumpable, IFMODParameterUpdater {
   ...
   private static void LoadVehicleTextures(VehicleScript.Skin var0) {
      ...
      if (var0.textureMask != null) {
         byte var1 = 0;
         int var2 = var1 | 256;
         var0.textureDataMask = LoadVehicleTexture(var0.textureMask, var2);
      }
   ...
   public void setNetPlayerAuthorization(BaseVehicle.Authorization var1, int var2) {
   ...
   public boolean isNetPlayerAuthorization(BaseVehicle.Authorization var1) {
   ...
   public void update() {
      if (this.removedFromWorld) {
            ...
            if (this.getVehicleTowing().scriptName.equals("Base.Trailer")) {
               ...
               if (this.getCurrentSpeedKmHour() > 30.0F && var2.getCondition() < 50 && !var2.container.Items.isEmpty()) {
                  ...
                  for(var4 = 0; var4 < var2.container.Items.size(); ++var4) {
                     if ((double)((InventoryItem)var2.container.Items.get(var4)).getWeight() >= 3.5D) {
                  ...
                  if (!var3.isEmpty()) {
                     ...
                     var31 = (int)(Math.pow((double)(100 - var4 * 2), 2.0D) * 0.3D * (1.0D + (double)(100 - var5 / 2) * 0.005D) * (1.0D + (double)(100 - var5 / 2) * 0.005D) * (double)(1.0F + var30 / 3.0F));
         ...
         if (this.physics != null) {
            ...
            this.doAlarm();
            BaseVehicle.VehicleImpulse var29 = this.impulseFromServer;
            if (!GameServer.bServer && var29 != null && var29.enable) {
               ...
               Vector3f var33 = var29.rel_pos.cross(var29.impulse, (Vector3f)((BaseVehicle.Vector3fObjectPool)TL_vector3f_pool.get()).alloc());
            ...
            if (System.currentTimeMillis() - this.engineCheckTime > (long)var32 && !GameClient.bClient) {
               ...
               if (!GameClient.bClient) {
                  if (this.engineState != BaseVehicle.engineStateTypes.Idle) {
                     var31 = (int)((double)this.engineLoudness * this.engineSpeed / 2500.0D);
                     double var35 = Math.min(this.getEngineSpeed(), 2000.0D);
                     var31 = (int)((double)var31 * (1.0D + var35 / 4000.0D));
                     var11 = 120;
                     if (GameServer.bServer) {
            ...
            this.updateTransform();
            Vector3f var38 = allocVector3f().set((Vector3fc)this.jniLinearVelocity);
            if (this.jniIsCollide && this.limitCrash.Check()) {
               this.jniIsCollide = false;
               this.limitCrash.Reset();
               Vector3f var39 = allocVector3f();
               var39.set((Vector3fc)var38).sub(this.lastLinearVelocity);
               var39.y = 0.0F;
            ...
            this.lastLinearVelocity.set((Vector3fc)var38);
         ...
         for(var21 = 0; var21 < this.impulseFromSquishedZombie.length; ++var21) {
            BaseVehicle.VehicleImpulse var23 = this.impulseFromSquishedZombie[var21];
            if (var23 != null) {
               var23.enable = false;
            }
         }
         ...
         for(var21 = 0; var21 < this.getScript().getPassengerCount(); ++var21) {
            if (this.getCharacter(var21) != null) {
               Vector3f var27 = this.getPassengerWorldPos(var21, (Vector3f)((BaseVehicle.Vector3fObjectPool)TL_vector3f_pool.get()).alloc());
               this.getCharacter(var21).setX(var27.x);
               this.getCharacter(var21).setY(var27.y);
               this.getCharacter(var21).setZ(var27.z * 1.0F);
               ((BaseVehicle.Vector3fObjectPool)TL_vector3f_pool.get()).release(var27);
            }
         }
         ...
         for(var6 = 0; var6 < this.getMaxPassengers(); ++var6) {
            BaseVehicle.Passenger var34 = this.getPassenger(var6);
   ...
   private void applyImpulseFromHitZombies() {
      if (!this.impulseFromHitZombie.isEmpty()) {
         if ((!GameClient.bClient || this.hasAuthorization(GameClient.connection)) && !GameServer.bServer) {
            Vector3f var7 = ((Vector3f)((BaseVehicle.Vector3fObjectPool)TL_vector3f_pool.get()).alloc()).set(0.0F, 0.0F, 0.0F);
            Vector3f var8 = ((Vector3f)((BaseVehicle.Vector3fObjectPool)TL_vector3f_pool.get()).alloc()).set(0.0F, 0.0F, 0.0F);
            Vector3f var9 = ((Vector3f)((BaseVehicle.Vector3fObjectPool)TL_vector3f_pool.get()).alloc()).set(0.0F, 0.0F, 0.0F);
            ...
            for(int var2 = this.impulseFromHitZombie.size(); var1 < var2; ++var1) {
               BaseVehicle.VehicleImpulse var3 = (BaseVehicle.VehicleImpulse)this.impulseFromHitZombie.get(var1);
               var3.release();
               var3.enable = false;
            }
   ...
   public void authorizationServerCollide(short var1, boolean var2) {
      if (!this.isNetPlayerAuthorization(BaseVehicle.Authorization.Local)) {
         if (var2) {
            ...
            BaseVehicle.Authorization var3 = var1 == -1 ? BaseVehicle.Authorization.Server : BaseVehicle.Authorization.Local;
   ...
   public void netPlayerFromServerUpdate(BaseVehicle.Authorization var1, short var2) {
   ...
   public Vector3f getLinearVelocity(Vector3f var1) {
      return var1.set((Vector3fc)this.jniLinearVelocity);
   }
   ...
   public boolean isExitBlocked(IsoGameCharacter var1, int var2) {
      ...
      if (var3 != null && var4 != null) {
         Vector3f var5 = this.getPassengerPositionWorldPos(var4, (Vector3f)((BaseVehicle.Vector3fObjectPool)TL_vector3f_pool.get()).alloc());
         if (var4.area != null) {
            Vector2 var6 = (Vector2)((BaseVehicle.Vector2ObjectPool)TL_vector2_pool.get()).alloc();
         ...
         var5.z = 0.0F;
         Vector3f var9 = this.getPassengerPositionWorldPos(var3, (Vector3f)((BaseVehicle.Vector3fObjectPool)TL_vector3f_pool.get()).alloc());
   ...
   private void renderAuthorizations() {
      ...
      float var5 = 0.0F;
      if (this.getVehicleTowing() != null) {
         BaseVehicle.Vector3fObjectPool var6 = (BaseVehicle.Vector3fObjectPool)TL_vector3f_pool.get();
   ...
   public float getCurrentSpeedForRegulator() {
      return (float)Math.max(5.0D * Math.floor((double)(this.jniSpeed / 5.0F)), 5.0D);
   }
   ...
   public BaseVehicle setSmashed(String var1, boolean var2) {
      ...
      if (var3 != null) {
         ...
         var10.savedRot.set((Quaternionfc)this.savedRot);
         if (var2) {
   ...
   public static enum Authorization {
      ...
      private static final HashMap authorizations = new HashMap();

      public static BaseVehicle.Authorization valueOf(byte var0) {
         return (BaseVehicle.Authorization)authorizations.getOrDefault(var0, Server);
      }
      ...
      // $FF: synthetic method
      private static BaseVehicle.Authorization[] $values() {
         return new BaseVehicle.Authorization[]{Server, LocalCollide, RemoteCollide, Local, Remote};
      }
