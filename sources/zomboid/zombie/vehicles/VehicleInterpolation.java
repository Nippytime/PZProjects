   ...
   public boolean interpolationDataGet(float[] var1, float[] var2, long var3) {
      ...
      if (var5 == null) {
         if (var6 == null) {
            ...
            var1[var10++] = var6.vy;
            var1[var10++] = var6.vz;
            var1[var10++] = (float)var6.wheelsCount;

            for(int var11 = 0; var11 < var6.wheelsCount; ++var11) {
               var1[var10++] = var6.wheelSteering[var11];
               var1[var10++] = var6.wheelRotation[var11];
               var1[var10++] = var6.wheelSkidInfo[var11];
               var1[var10++] = var6.wheelSuspensionLength[var11];
            }
         ...
         var1[var10++] = (var5.y - var6.y) * var8 + var6.y;
         var1[var10++] = (var5.z - var6.z) * var8 + var6.z;
         ...
         var1[var10++] = tempQuaternionA.x;
         var1[var10++] = tempQuaternionA.y;
         var1[var10++] = tempQuaternionA.z;
         var1[var10++] = tempQuaternionA.w;
         var1[var10++] = (var5.vx - var6.vx) * var8 + var6.vx;
         var1[var10++] = (var5.vy - var6.vy) * var8 + var6.vy;
         var1[var10++] = (var5.vz - var6.vz) * var8 + var6.vz;
         var1[var10++] = (float)var5.wheelsCount;

         for(int var9 = 0; var9 < var5.wheelsCount; ++var9) {
            var1[var10++] = (var5.wheelSteering[var9] - var6.wheelSteering[var9]) * var8 + var6.wheelSteering[var9];
            var1[var10++] = (var5.wheelRotation[var9] - var6.wheelRotation[var9]) * var8 + var6.wheelRotation[var9];
            var1[var10++] = (var5.wheelSkidInfo[var9] - var6.wheelSkidInfo[var9]) * var8 + var6.wheelSkidInfo[var9];
            var1[var10++] = (var5.wheelSuspensionLength[var9] - var6.wheelSuspensionLength[var9]) * var8 + var6.wheelSuspensionLength[var9];
         }
