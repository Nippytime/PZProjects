...
public final class VehicleManager {
   ...
   private void sendVehiclesInternal(UdpConnection var1, ArrayList var2, PacketTypes.PacketType var3) {
      if (!var2.isEmpty()) {
   ...
   public void serverPacket(ByteBuffer var1, UdpConnection var2, short var3) {
      ...
      case 1:
         ...
         var20 = this.IDToVehicle.get(var5);
         if (var20 != null) {
            IsoGameCharacter var28 = var20.getCharacter(var6);
            if (var28 != null) {
               var20.setCharacterPosition(var28, var6, var21);
               this.sendPassengerPosition(var20, var6, var21, var2);
            }
         }
         break;
      case 2:
         ...
         var13 = var1.getShort();
         var19 = var1.get();
         DebugLog.Vehicle.trace("Vehicle enter vid=%d pid=%d seat=%d", var5, var13, Integer.valueOf(var19));
         var20 = this.IDToVehicle.get(var5);
         if (var20 == null) {
            DebugLog.Vehicle.warn("Vehicle vid=%d not found", var5);
         } else {
            var26 = (IsoPlayer)GameServer.IDToPlayerMap.get(var13);
            if (var26 == null) {
               DebugLog.Vehicle.warn("Player pid=%d not found", var13);
            } else {
               var27 = (IsoPlayer)Type.tryCastTo(var20.getCharacter(var19), IsoPlayer.class);
               if (var27 != null && var27 != var26) {
                  ...
                  var20.enter(var19, var26);
                  if (var19 == 0 && var20.isNetPlayerAuthorization(BaseVehicle.Authorization.Server)) {
                     var20.authorizationServerOnSeat(var26, true);
                  }

                  this.sendEnter(var20, var26, var19);
               }
            }
         }
         break;
      case 3:
         ...
         var13 = var1.getShort();
         var19 = var1.get();
         DebugLog.Vehicle.trace("Vehicle exit vid=%d pid=%d seat=%d", var5, var13, Integer.valueOf(var19));
         var20 = this.IDToVehicle.get(var5);
         if (var20 == null) {
            DebugLog.Vehicle.warn("Vehicle vid=%d not found", var5);
         } else {
            ...
            if (var26 == null) {
               ...
               var20.exit(var26);
               if (var19 == 0) {
                  var20.authorizationServerOnSeat(var26, false);
               }

               this.sendExit(var20, var26, var19);
            }
         }
         break;
      case 4:
         ...
         var19 = var1.get();
         byte var24 = var1.get();
         DebugLog.Vehicle.trace("Vehicle switch seat vid=%d pid=%d seats=%d=>%d", var5, var13, Integer.valueOf(var19), Integer.valueOf(var24));
         BaseVehicle var25 = this.IDToVehicle.get(var5);
         if (var25 == null) {
            DebugLog.Vehicle.warn("Vehicle vid=%d not found", var5);
         } else {
            var27 = (IsoPlayer)GameServer.IDToPlayerMap.get(var13);
            if (var27 == null) {
               DebugLog.Vehicle.warn("Player pid=%d not found", var13);
            } else {
               ...
               if (var11 != null && var11 != var27) {
                  ...
                  this.sendSwitchSeat(var25, var27, var19, var24);
               }
            }
         }
         break;
      ...
      case 9:
         ...
         for(var15 = 0; var15 < GameServer.udpEngine.connections.size(); ++var15) {
            UdpConnection var18 = (UdpConnection)GameServer.udpEngine.connections.get(var15);
            if (var2 != var18 && var12.isRelevant(var18)) {
      ...
      case 11:
         ...
         for(var15 = 0; var15 < var5; ++var15) {
            ...
            DebugLog.Vehicle.trace("Vehicle vid=%d full update response ", var17);
            var20 = this.IDToVehicle.get(var17);
            if (var20 != null) {
               if (var20.connectionState[var2.index] == null) {
                  var20.connectionState[var2.index] = new BaseVehicle.ServerVehicleState();
               }
      ...
      case 12:
         var5 = var1.getShort();
         DebugLog.Vehicle.trace("%s vid=%d", vehiclePacketTypes.get(var4), var5);
         BaseVehicle var14 = this.IDToVehicle.get(var5);
         if (var14 != null) {
            var14.updateFlags = (short)(var14.updateFlags | 2);
            this.sendVehicles(var2, var3);
         }
         break;
      case 15:
         ...
         DebugLog.Vehicle.trace("%s vid=%d pid=%d %b", vehiclePacketTypes.get(var4), var5, var13, var16);
         var20 = this.IDToVehicle.get(var5);
         if (var20 != null) {
      ...
      for(var2 = 0; var2 < var9.size(); ++var2) {
         ...
         if (var3.interpolation.interpolationDataGet(var4, this.engineSound)) {
            if (!var3.isNetPlayerAuthorization(BaseVehicle.Authorization.Local) && !var3.isNetPlayerAuthorization(BaseVehicle.Authorization.LocalCollide)) {
               ...
               float var6 = var4[1];
               float var7 = var4[2];
               IsoGridSquare var8 = IsoWorld.instance.CurrentCell.getGridSquare((double)var5, (double)var6, 0.0D);
   ...
   private void clientReceiveUpdate(ByteBuffer var1) throws IOException {
      ...
      if (var9 == null && var8 == null) {
         ...
         if (var9 != null && var8 == null) {
            ...
            for(var28 = 0; var28 < IsoPlayer.numPlayers; ++var28) {
               IsoPlayer var33 = IsoPlayer.players[var28];
            ...
            if ((var3 & 1) != 0) {
               ...
               if ((var3 & 8) != 0) {
                  ...
                  for(var20 = 0; var20 < var9.getLightCount(); ++var20) {
                     var11 = var1.get() == 1;
                     var9.getLightByIndex(var20).getLight().setActive(var11);
                  }
               }
               ...
               if ((var3 & 16) != 0) {
                  for(var10 = var1.get(); var10 != -1; var10 = var1.get()) {
                     ...
                     var21.getModData().load((ByteBuffer)var1, 195);
               ...
               if ((var3 & 32) != 0) {
                  for(var10 = var1.get(); var10 != -1; var10 = var1.get()) {
                     ...
                     var24 = var9.getPartByIndex(var10);
               ...
               if ((var3 & 128) != 0) {
                  for(var10 = var1.get(); var10 != -1; var10 = var1.get()) {
                     ...
                     int var27 = var21.getWheelIndex();
                     if (var27 != -1) {
                        var9.setTireRemoved(var27, !var26);
                     }
               ...
               if ((var3 & 64) != 0) {
                  ...
                  for(var28 = 0; var28 < this.oldModels.size(); ++var28) {
                     BaseVehicle.ModelInfo var30 = (BaseVehicle.ModelInfo)this.oldModels.get(var28);
               ...
               for(var28 = 0; var28 < var9.getPartCount(); ++var28) {
                  var24 = var9.getPartByIndex(var28);
