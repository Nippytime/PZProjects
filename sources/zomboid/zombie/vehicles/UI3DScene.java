...
public final class UI3DScene extends UIElement {
   ...
   public UI3DScene(KahluaTable var1) {
      ...
      for(int var2 = 0; var2 < this.m_stateData.length; ++var2) {
         ...
         this.m_stateData[var2].m_gridPlaneDrawer = new UI3DScene.GridPlaneDrawer(this);
   ...
   public Object fromLua1(String var1, Object var2) {
      ...
      case -1706380656:
         ...
         break;
      case -1539752816:
         if (var1.equals("setDrawGridPlane")) {
            var4 = 16;
         }
         break;
      case -1494527684:
   ...
   public Object fromLua2(String var1, Object var2, Object var3) {
      ...
      case 407314410:
         ...
         break;
      case 628034626:
         if (var1.equals("setModelWeaponRotationHack")) {
            var5 = 22;
         }
         break;
      case 886449800:
      ...
      case 1728054510:
         ...
         break;
      case 2083897877:
         if (var1.equals("setModelUseWorldAttachment")) {
            var5 = 21;
         }
      }
      ...
      String var18;
      UI3DScene.SceneModel var19;
      UI3DScene.SceneCharacter var21;
      AnimationPlayer var22;
      ModelAttachment var26;
      UI3DScene.SceneModel var27;
      AnimationMultiTrack var33;
      switch(var5) {
      case 0:
         var19 = (UI3DScene.SceneModel)this.getSceneObjectById((String)var2, UI3DScene.SceneModel.class, true);
         ...
         return var26;
      case 1:
         var21 = (UI3DScene.SceneCharacter)this.getSceneObjectById((String)var2, UI3DScene.SceneCharacter.class, true);
         var18 = (String)var3;
         UI3DScene.PositionRotation var41 = var21.getBoneAxis(var18, (UI3DScene.PositionRotation)s_posRotPool.alloc());
      ...
      case 3:
         ...
         if (var17 != null) {
            ...
            if (var32 == null) {
               ...
               var27 = new UI3DScene.SceneModel(this, (String)var2, var32, var39);
      ...
      case 17:
         ...
         return null;
      case 18:
         String var24 = (String)var2;
         byte var8 = -1;
         switch(var24.hashCode()) {
         case -2046552227:
            if (var24.equals("vehicleModel")) {
               var8 = 4;
            }
            break;
         case -177460704:
            if (var24.equals("centerOfMass")) {
               var8 = 0;
            }
            break;
         case 104069929:
            if (var24.equals("model")) {
               var8 = 3;
            }
            break;
         case 739104294:
            if (var24.equals("chassis")) {
               var8 = 1;
            }
            break;
         case 1564195625:
            if (var24.equals("character")) {
               var8 = 2;
            }
         }
         ...
         case 1:
            ...
            break;
         case 2:
            UI3DScene.SceneCharacter var28 = (UI3DScene.SceneCharacter)this.getSceneObjectById((String)var3, UI3DScene.SceneCharacter.class, true);
            this.m_gizmoParent = var28;
            this.m_gizmoOrigin = this.m_gizmoParent;
            this.m_gizmoChild = null;
            break;
         case 3:
            var27 = (UI3DScene.SceneModel)this.getSceneObjectById((String)var3, UI3DScene.SceneModel.class, true);
   ...
   public static int intersect_ray_plane(UI3DScene.Plane var0, UI3DScene.Ray var1, Vector3f var2) {
      Vector3f var3 = allocVector3f().set((Vector3fc)var1.direction).mul(100.0F);
      Vector3f var4 = allocVector3f().set((Vector3fc)var1.origin).sub(var0.point);
      ...
      try {
         ...
         var2.set((Vector3fc)var1.origin).add(var3.mul(var7));
         var8 = 1;
      } finally {
         releaseVector3f(var3);
         releaseVector3f(var4);
   ...
   private abstract static class SceneObject {
      ...
      Matrix4f getLocalTransform(Matrix4f var1) {
         UI3DScene.SceneModel var2 = (UI3DScene.SceneModel)Type.tryCastTo(this, UI3DScene.SceneModel.class);
      ...
      public void render() {
         ...
         if (var3 != null && var2.Mesh != null && var2.Mesh.isReady()) {
            ...
            for(int var5 = 0; var5 < 5; ++var5) {
               var3.setLight(var5, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, Float.NaN, 0.0F, 0.0F, 0.0F, (IsoMovingObject)null);
            }
