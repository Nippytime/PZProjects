...
public class Texture extends Asset implements IDestroyable, ITexture, Serializable {
   ...
   public void saveOnRenderThread(String var1) {
      if (this.getID() == -1) {
         ...
         int var9 = (int)PZMath.floor(this.getXStart() * (float)var4);
         int var10 = (int)PZMath.floor(this.getYStart() * (float)var5);

         for(int var11 = 0; var11 < var8.length; ++var11) {
            int var12 = var9 + var11 % var2;
            int var13 = var10 + var11 / var2;
            int var14 = (var12 + var13 * var4) * var6;
            var8[var11] = (var7.get(var14 + 3) & 255) << 24 | (var7.get(var14) & 255) << 16 | (var7.get(var14 + 1) & 255) << 8 | (var7.get(var14 + 2) & 255) << 0;
         }
