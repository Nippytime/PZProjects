...
public final class HumanVisual extends BaseVisual {
   ...
   public void load(ByteBuffer var1, int var2) throws IOException {
      ...
      for(var5 = 0; var5 < var9; ++var5) {
         ItemVisual var11 = new ItemVisual();
         var11.load(var1, var2);
         this.bodyVisuals.add(var11);
      }
   ...
   public ModelScript getModelScript() {
      return this.forceModelScript != null ? ScriptManager.instance.getModelScript(this.forceModelScript) : ScriptManager.instance.getModelScript(this.isFemale() ? "FemaleBody" : "MaleBody");
   }
         ...
         for(int var4 = 0; var4 < var3.length; ++var4) {
            ...
            if (var5 != -1) {
               ...
               case -1427300215:
                  ...
                  break;
               case -1034075528:
                  if (var6.equals("naturalHairColor")) {
                     var9 = 6;
                  }
                  break;
               case 284826785:
               ...
               case 351608024:
                  ...
                  break;
               case 394260252:
                  if (var6.equals("naturalBeardColor")) {
                     var9 = 2;
                  }
                  break;
               case 1702284452:
               ...
               case 2:
                  var10 = colorFromString(var7);
                  if (var10 != null) {
                     this.setNaturalBeardColor(var10);
                  }
                  break;
               case 3:
               ...
               case 6:
                  var10 = colorFromString(var7);
                  if (var10 != null) {
                     this.setNaturalHairColor(var10);
                  }
                  break;
               case 7:
