...
public final class DeadBodyAtlas {
   ...
   public DeadBodyAtlas.BodyTexture getBodyTexture(IsoDeadBody var1) {
      this.bodyParams.init(var1);
      return this.getBodyTexture(this.bodyParams);
   }

   public DeadBodyAtlas.BodyTexture getBodyTexture(IsoZombie var1) {
      this.bodyParams.init(var1);
      return this.getBodyTexture(this.bodyParams);
   }

   public DeadBodyAtlas.BodyTexture getBodyTexture(IsoMannequin var1) {
      this.bodyParams.init(var1);
      return this.getBodyTexture(this.bodyParams);
   }

   public DeadBodyAtlas.BodyTexture getBodyTexture(boolean var1, String var2, String var3, IsoDirections var4, int var5, float var6) {
      CharacterTextures var7 = var1 ? this.characterTexturesFemale : this.characterTexturesMale;
      DeadBodyAtlas.BodyTexture var8 = var7.getTexture(var2, var3, var4, var5);
      if (var8 != null) {
         return var8;
      } else {
         ...
         DeadBodyAtlas.BodyTexture var9 = this.getBodyTexture(this.bodyParams);
         var7.addTexture(var2, var3, var4, var5, var9);
         return var9;
      }
   }

   public DeadBodyAtlas.BodyTexture getBodyTexture(DeadBodyAtlas.BodyParams var1) {
      String var2 = this.getBodyKey(var1);
      DeadBodyAtlas.BodyTexture var3 = (DeadBodyAtlas.BodyTexture)this.EntryMap.get(var2);
      if (var3 != null) {
         return var3;
      } else {
         DeadBodyAtlas.AtlasEntry var4 = new DeadBodyAtlas.AtlasEntry();
         var4.key = var2;
         var4.lightKey = this.getLightKey(var1);
         var4.updateCounter = this.updateCounter;
         var3 = new DeadBodyAtlas.BodyTexture();
         var3.entry = var4;
   ...
   public void checkLights(Texture var1, IsoDeadBody var2) {
      if (var1 != null) {
         DeadBodyAtlas.BodyTexture var3 = (DeadBodyAtlas.BodyTexture)this.EntryMap.get(var1.getName());
         if (var3 != null) {
            DeadBodyAtlas.AtlasEntry var4 = var3.entry;
            if (var4 != null && var4.tex == var1) {
               if (var4.updateCounter != this.updateCounter) {
                  ...
                  if (!var4.lightKey.equals(var5)) {
                     ...
                     DeadBodyAtlas.RenderJob var6 = DeadBodyAtlas.RenderJob.getNew().init(this.bodyParams, var4);
   ...
   private void assignEntryToAtlas(DeadBodyAtlas.AtlasEntry var1, int var2, int var3) {
      if (var1.atlas == null) {
         for(int var4 = 0; var4 < this.AtlasList.size(); ++var4) {
            DeadBodyAtlas.Atlas var5 = (DeadBodyAtlas.Atlas)this.AtlasList.get(var4);
         ...
         DeadBodyAtlas.Atlas var6 = new DeadBodyAtlas.Atlas(1024, 1024, var2, var3);
         var6.addEntry(var1);
   ...
   public static final class BodyTexture {
      ...
      public void render(float var1, float var2, float var3, float var4, float var5, float var6) {
         if (this.entry.ready && this.entry.tex.isReady()) {
            ...
            SpriteRenderer.instance.drawGeneric(((DeadBodyAtlas.BodyTextureDrawer)DeadBodyAtlas.instance.bodyTextureDrawerPool.alloc()).init(this, var1, var2, var3, var4, var5, var6));
         }
      }
   ...
   private static final class RenderJob extends TextureDraw.GenericDrawer {
      ...
      void calcMatrices(Matrix4f var1, Matrix4f var2, float var3, float var4) {
         ...
         float var10 = (float)Math.sqrt(2048.0D);
   ...
   private final class Atlas {
      ...
      public void addEntry(DeadBodyAtlas.AtlasEntry var1) {
         int var2 = this.tex.getWidth() / this.ENTRY_WID;
         int var3 = this.EntryList.size();
         int var4 = var3 % var2;
         int var5 = var3 / var2;
   ...
   private static final class BodyTextureDrawer extends TextureDraw.GenericDrawer {
      ...
      DeadBodyAtlas.BodyTextureDrawer init(DeadBodyAtlas.BodyTexture var1, float var2, float var3, float var4, float var5, float var6, float var7) {
      ...
      public void render() {
         DeadBodyAtlas.AtlasEntry var1 = this.bodyTexture.entry;
