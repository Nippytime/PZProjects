      ...
      if (var3 == null) {
         ...
         if (var4 == null) {
            ...
            if (var9 != null && var9.isReady() && var9.Mesh != null && var9.Mesh.isReady()) {
               WorldItemModelDrawer.WeaponPartParams var10 = (WorldItemModelDrawer.WeaponPartParams)s_weaponPartParamPool.alloc();
               var10.m_model = var9;
               ...
               this.m_transform.mul((Matrix4fc)var10.m_transform, var10.m_transform);
               if (this.m_weaponParts == null) {
   ...
   public void render() {
      ...
      if (this.m_weaponParts != null) {
         for(int var1 = 0; var1 < this.m_weaponParts.size(); ++var1) {
            WorldItemModelDrawer.WeaponPartParams var2 = (WorldItemModelDrawer.WeaponPartParams)this.m_weaponParts.get(var1);
   ...
   void renderModel(Model var1, Matrix4f var2) {
      if (var1.bStatic) {
         ...
         if (var3 != null && var1.Mesh != null && var1.Mesh.isReady()) {
            ...
            float var5 = 1.5F;
            var3.setLight(4, var6.x, var6.z, var6.y, this.m_ambientR / 4.0F * var5, this.m_ambientG / 4.0F * var5, this.m_ambientB / 4.0F * var5, 5000.0F, Float.NaN, 0.0F, 0.0F, 0.0F, (IsoMovingObject)null);
