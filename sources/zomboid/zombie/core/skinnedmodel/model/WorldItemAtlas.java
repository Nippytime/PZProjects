...
public final class WorldItemAtlas {
   ...
   public WorldItemAtlas.ItemTexture getItemTexture(InventoryItem var1) {
      return this.itemParams.init(var1) ? this.getItemTexture(this.itemParams) : null;
   }

   public WorldItemAtlas.ItemTexture getItemTexture(WorldItemAtlas.ItemParams var1) {
      String var2 = this.getItemKey(var1);
      WorldItemAtlas.ItemTexture var3 = (WorldItemAtlas.ItemTexture)this.itemTextureMap.get(var2);
      if (var3 != null) {
         return var3;
      } else {
         WorldItemAtlas.AtlasEntry var4 = new WorldItemAtlas.AtlasEntry();
         var4.key = var2;
         var3 = new WorldItemAtlas.ItemTexture();
   ...
   private void assignEntryToAtlas(WorldItemAtlas.AtlasEntry var1, int var2, int var3) {
      if (var1.atlas == null) {
         for(int var4 = 0; var4 < this.AtlasList.size(); ++var4) {
            WorldItemAtlas.Atlas var5 = (WorldItemAtlas.Atlas)this.AtlasList.get(var4);
         ...
         WorldItemAtlas.Atlas var6 = new WorldItemAtlas.Atlas(512, 512, var2, var3);
         var6.addEntry(var1);
         this.AtlasList.add(var6);
      }
   }

   private String getItemKey(WorldItemAtlas.ItemParams var1) {
      try {
         ...
         if (var1.m_weaponParts != null) {
            for(int var2 = 0; var2 < var1.m_weaponParts.size(); ++var2) {
               WorldItemAtlas.WeaponPartParams var3 = (WorldItemAtlas.WeaponPartParams)var1.m_weaponParts.get(var2);
   ...
   public void render() {
      ...
      for(var1 = 0; var1 < this.AtlasList.size(); ++var1) {
         WorldItemAtlas.Atlas var2 = (WorldItemAtlas.Atlas)this.AtlasList.get(var1);
         if (var2.clear) {
            SpriteRenderer.instance.drawGeneric(new WorldItemAtlas.ClearAtlasTexture(var2));
         }
      }

      if (!this.RenderJobs.isEmpty()) {
         for(var1 = 0; var1 < this.RenderJobs.size(); ++var1) {
            WorldItemAtlas.RenderJob var3 = (WorldItemAtlas.RenderJob)this.RenderJobs.get(var1);
   ...
   private static final class ItemParams {
      ...
      void copyFrom(WorldItemAtlas.ItemParams var1) {
         ...
         if (var1.m_weaponParts != null) {
            ...
            for(int var2 = 0; var2 < var1.m_weaponParts.size(); ++var2) {
               WorldItemAtlas.WeaponPartParams var3 = (WorldItemAtlas.WeaponPartParams)var1.m_weaponParts.get(var2);
               this.m_weaponParts.add(((WorldItemAtlas.WeaponPartParams)WorldItemAtlas.instance.weaponPartParamPool.alloc()).init(var3));
            }
         }
         ...
         this.m_angle.set((Vector3fc)var1.m_angle);
         this.m_transform.set((Matrix4fc)var1.m_transform);
      }
         ...
         if (var3 == null) {
            ...
            if (var4 == null) {
               ...
               if (var9 != null && var9.isReady() && var9.Mesh != null && var9.Mesh.isReady()) {
                  WorldItemAtlas.WeaponPartParams var10 = (WorldItemAtlas.WeaponPartParams)WorldItemAtlas.instance.weaponPartParamPool.alloc();
                  var10.m_model = var9;
      ...
      void init(InventoryItem var1, Model var2, ModelScript var3, float var4, ImmutableColor var5, float var6, boolean var7) {
         ...
         if (var2.Mesh != null && var2.Mesh.isReady() && var2.Mesh.m_transform != null) {
            ...
            this.m_transform.mul((Matrix4fc)var2.Mesh.m_transform);
            var2.Mesh.m_transform.transpose();
         }

      }

      WorldItemAtlas.ItemParams.FoodState getFoodState(Food var1) {
         WorldItemAtlas.ItemParams.FoodState var2 = WorldItemAtlas.ItemParams.FoodState.Normal;
         if (var1.isCooked()) {
   ...
   public static final class ItemTexture {
      ...
      public void render(float var1, float var2, float var3, float var4, float var5, float var6) {
         if (this.entry.ready && this.entry.tex.isReady()) {
            ...
            SpriteRenderer.instance.drawGeneric(((WorldItemAtlas.ItemTextureDrawer)WorldItemAtlas.instance.itemTextureDrawerPool.alloc()).init(this, var1, var2, var3, var4, var5, var6));
         }
      }
   ...
   private static final class RenderJob extends TextureDraw.GenericDrawer {
      ...
      public WorldItemAtlas.RenderJob init(WorldItemAtlas.ItemParams var1, WorldItemAtlas.AtlasEntry var2) {
                  ...
                  if (this.entryW <= 512 && this.entryH <= 512) {
                     ...
                     if (this.itemParams.m_weaponParts != null && !this.itemParams.m_weaponParts.isEmpty()) {
                        for(int var8 = 0; var8 < this.itemParams.m_weaponParts.size(); ++var8) {
                           WorldItemAtlas.WeaponPartParams var9 = (WorldItemAtlas.WeaponPartParams)this.itemParams.m_weaponParts.get(var8);
         ...
         if (!var1.bStatic) {
            ...
            if (var3 != null && var1.Mesh != null && var1.Mesh.isReady()) {
               if (var1.tex != null && !var1.tex.isReady()) {
                  ...
                  Matrix4f var4 = tempMatrix4f_1.set((Matrix4fc)this.m_modelView);
                  Matrix4f var5 = tempMatrix4f_2.set((Matrix4fc)this.itemParams.m_transform).invert();
                  var4.mul((Matrix4fc)var5);
                  ...
                  for(int var6 = 0; var6 < 5; ++var6) {
                     var3.setLight(var6, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, Float.NaN, 0.0F, 0.0F, 0.0F, (IsoMovingObject)null);
                  }
                  ...
                  float var7 = 1.5F;
                  var3.setLight(4, var8.x, var8.z, var8.y, this.itemParams.m_ambientR / 4.0F * var7, this.itemParams.m_ambientG / 4.0F * var7, this.itemParams.m_ambientB / 4.0F * var7, 5000.0F, Float.NaN, 0.0F, 0.0F, 0.0F, (IsoMovingObject)null);
                  if (var2 == null) {
                     var3.setTransformMatrix(this.itemParams.m_transform, false);
                  } else {
                     tempMatrix4f_1.set((Matrix4fc)this.itemParams.m_transform);
                     tempMatrix4f_1.mul((Matrix4fc)var2);
      ...
      void calcMatrices(Matrix4f var1, Matrix4f var2, float var3, float var4) {
         ...
         var2.mul((Matrix4fc)this.itemParams.m_transform);
      }
      ...
      void calcModelBounds(float[] var1) {
         ...
         if (this.itemParams.m_weaponParts != null) {
            for(int var2 = 0; var2 < this.itemParams.m_weaponParts.size(); ++var2) {
               WorldItemAtlas.WeaponPartParams var3 = (WorldItemAtlas.WeaponPartParams)this.itemParams.m_weaponParts.get(var2);
               Matrix4f var4 = tempMatrix4f_1.set((Matrix4fc)this.m_modelView).mul((Matrix4fc)var3.m_transform);
   ...
   private final class Atlas {
      ...
      public WorldItemAtlas.AtlasEntry addItem(String var1) {
         int var2 = this.tex.getWidth() / this.ENTRY_WID;
         int var3 = this.EntryList.size();
         int var4 = var3 % var2;
         int var5 = var3 / var2;
         WorldItemAtlas.AtlasEntry var6 = new WorldItemAtlas.AtlasEntry();
         var6.atlas = this;
         var6.key = var1;
      ...
      public void addEntry(WorldItemAtlas.AtlasEntry var1) {
         int var2 = this.tex.getWidth() / this.ENTRY_WID;
         int var3 = this.EntryList.size();
         int var4 = var3 % var2;
         int var5 = var3 / var2;
   ...
   private static final class WeaponPartParams {
      ...
      void initTransform(ModelScript var1, ModelScript var2) {
         ...
         if (var4 != null) {
            ...
            this.m_transform.mul((Matrix4fc)var3);
         }
   ...
   private static final class ClearAtlasTexture extends TextureDraw.GenericDrawer {
      ...
      ClearAtlasTexture(WorldItemAtlas.Atlas var1) {
         this.m_atlas = var1;
      }
   ...
   private static final class ItemTextureDrawer extends TextureDraw.GenericDrawer {
      ...
      WorldItemAtlas.ItemTextureDrawer init(WorldItemAtlas.ItemTexture var1, float var2, float var3, float var4, float var5, float var6, float var7) {
      ...
      public void render() {
         WorldItemAtlas.AtlasEntry var1 = this.itemTexture.entry;
