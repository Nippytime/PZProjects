...
public final class ModelManager {
   ...
   public void loadModAnimations() {
      ...
      for(int var3 = 0; var3 < var13.size(); ++var3) {
         ...
         if (var5 != null && var5.animsXFile.isDirectory()) {
            ModelManager.ModAnimations var6 = (ModelManager.ModAnimations)this.m_modAnimations.get(var4);
            if (var6 != null) {
               var6.setPriority(var3 + 1);
            } else {
               var6 = new ModelManager.ModAnimations(var4);
               var6.setPriority(var3 + 1);
   ...
   void setActiveAnimations() {
      ...
      label45:
      while(true) {
         ModelManager.ModAnimations var7;
         do {
            if (!var2.hasNext()) {
               return;
            }

            var7 = (ModelManager.ModAnimations)var2.next();
         } while(!var7.isActive());
   ...
   private void loadHumanAnimations(ChooseGameInfo.Mod var1, ModelManager.ModAnimations var2) {
