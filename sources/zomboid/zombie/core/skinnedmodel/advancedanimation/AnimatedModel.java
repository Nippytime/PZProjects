...
public final class AnimatedModel extends AnimationVariableSource implements IAnimatable, IAnimEventCallback, IActionStateChanged, IHumanVisual {
   ...
   private void initRenderData(AnimatedModel.StateInfo var1, AnimatedModel.AnimatedModelInstanceRenderData var2, ModelInstance var3) {
      AnimatedModel.AnimatedModelInstanceRenderData var4 = ((AnimatedModel.AnimatedModelInstanceRenderData)instDataPool.alloc()).init(var3);
   ...
   public int renderMain() {
      ...
      if (this.modelInstance != null) {
         ...
         this.initRenderData(var1, (AnimatedModel.AnimatedModelInstanceRenderData)null, this.modelInstance);
      }
      ...
      for(int var6 = 0; var6 < var1.readyData.size(); ++var6) {
         AnimatedModel.AnimatedModelInstanceRenderData var3 = (AnimatedModel.AnimatedModelInstanceRenderData)var1.readyData.get(var6);
   ...
   public void DoRender(ModelCamera var1) {
      ...
      for(int var5 = 0; var5 < var3.instData.size(); ++var5) {
         AnimatedModel.AnimatedModelInstanceRenderData var6 = (AnimatedModel.AnimatedModelInstanceRenderData)var3.instData.get(var5);
