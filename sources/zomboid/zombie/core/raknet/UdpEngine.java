   ...
   private void decode(ByteBuffer var1) {
      ...
      case 16:
         ...
         if (GameClient.bClient) {
            GameClient.connection = this.addConnection(var9, var4);
            ConnectionManager.log("RakNet", "connection-request-accepted", this.connectionArray[var9]);
      ...
      case 19:
         ...
         ConnectionManager.log("RakNet", "new-incoming-connection", this.connectionArray[var9]);
         break;
      case 20:
         var9 = var1.get() & 255;
         ConnectionManager.log("RakNet", "no-free-incoming-connections", this.connectionArray[var9]);
         break;
      case 21:
         var9 = var1.get() & 255;
         var4 = this.peer.getGuidOfPacket();
         ConnectionManager.log("RakNet", "disconnection-notification", this.connectionArray[var9]);
      ...
      case 22:
         var9 = var1.get() & 255;
         ConnectionManager.log("RakNet", "connection-lost", this.connectionArray[var9]);
         this.removeConnection(var9);
         break;
      case 23:
         var9 = var1.get() & 255;
         ConnectionManager.log("RakNet", "connection-banned", this.connectionArray[var9]);
         if (GameClient.bClient) {
            GameClient.instance.addDisconnectPacket(var2);
         }
         break;
      case 24:
         var9 = var1.get() & 255;
         ConnectionManager.log("RakNet", "invalid-password", this.connectionArray[var9]);
         if (GameClient.bClient) {
            GameClient.instance.addDisconnectPacket(var2);
         }
         break;
      case 25:
         ...
         LuaEventManager.triggerEvent("OnConnectionStateChanged", "ClientVersionMismatch", var10);
         break;
      case 31:
         var9 = var1.get() & 255;
         ConnectionManager.log("RakNet", "remote-disconnection-notification", this.connectionArray[var9]);
         break;
      case 32:
         var9 = var1.get() & 255;
         ConnectionManager.log("RakNet", "remote-connection-lost", this.connectionArray[var9]);
         if (GameClient.bClient) {
            GameClient.instance.addDisconnectPacket(var2);
         }
         break;
      case 33:
         var9 = var1.get() & 255;
         ConnectionManager.log("RakNet", "remote-new-incoming-connection", this.connectionArray[var9]);
         break;
      case 44:
