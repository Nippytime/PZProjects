               ...
               if (var4 != null && !var4.getMovingObjects().isEmpty() && (var4 == this.current || !this.current.isBlockedTo(var4))) {
                  ...
                  for(int var7 = var4.getMovingObjects().size(); var6 < var7; ++var6) {
                     ...
                     if (var8 != this && var8.isSolidForSeparate() && !(Math.abs(this.z - var8.z) > 0.3F)) {
                        ...
                        if (var9 != null) {
                           if (var2 != null && var2.getBumpedChr() != var8 && var13 < var11 + var5 && (double)var2.getForwardDirection().angleBetween(var12) > 2.6179938155736564D && var2.getBeenSprintingFor() >= 70.0F && WeaponType.getWeaponType((IsoGameCharacter)var2) == WeaponType.spear) {
