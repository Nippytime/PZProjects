            ...
            if (var7 >= 1 && var8 != "Winter") {
               if (SandboxOptions.instance.MaggotSpawn.getValue() != 3) {
                  ...
                  for(int var10 = 0; var10 < var7; ++var10) {
                     ...
                     if (this.wasZombie) {
                        if (Rand.Next(var9) == 0) {
                           var11 = InventoryItemFactory.CreateItem("Maggots");
                        ...
                        if (Rand.Next(var9 * 2) == 0 && SandboxOptions.instance.MaggotSpawn.getValue() != 2) {
                           var11 = InventoryItemFactory.CreateItem("Maggots");
                           if (var11 != null && this.getSquare() != null) {
                              this.getSquare().AddWorldInventoryItem(var11, (float)(Rand.Next(10) / 10), (float)(Rand.Next(10) / 10), 0.0F);
                              if (var11 instanceof Food) {
                                 ((Food)var11).setPoisonPower(5);
                              }
                           }
