...
public class IsoMannequin extends IsoObject implements IHumanVisual {
   ...
   public void render(float var1, float var2, float var3, ColorInfo var4, boolean var5, boolean var6, Shader var7) {
      ...
      if (this.bAnimate) {
         ...
         IsoMannequin.Drawer var11 = this.drawers[SpriteRenderer.instance.getMainStateIndex()];
   ...
   private void getPropertiesFromSprite() {
      ...
      case 1420407857:
         if (var1.equals("location_shop_mall_01_65")) {
            var2 = 0;
         }
         break;
      case 1420407858:
         if (var1.equals("location_shop_mall_01_66")) {
            var2 = 1;
         }
         break;
      case 1420407859:
         if (var1.equals("location_shop_mall_01_67")) {
            var2 = 2;
         }
         break;
      case 1420407860:
         if (var1.equals("location_shop_mall_01_68")) {
            var2 = 3;
         }
         break;
      case 1420407861:
         if (var1.equals("location_shop_mall_01_69")) {
            var2 = 4;
         }
      case 1420407862:
      case 1420407863:
      ...
      default:
         break;
      case 1420407883:
         if (var1.equals("location_shop_mall_01_70")) {
            var2 = 5;
         }
         break;
      case 1420407886:
         if (var1.equals("location_shop_mall_01_73")) {
            var2 = 6;
         }
         break;
      case 1420407887:
         if (var1.equals("location_shop_mall_01_74")) {
            var2 = 7;
         }
         break;
      case 1420407888:
         if (var1.equals("location_shop_mall_01_75")) {
            var2 = 8;
         }
         break;
      case 1420407889:
         if (var1.equals("location_shop_mall_01_76")) {
            var2 = 9;
         }
         break;
      case 1420407890:
         if (var1.equals("location_shop_mall_01_77")) {
            var2 = 10;
         }
         break;
      case 1420407891:
         if (var1.equals("location_shop_mall_01_78")) {
            var2 = 11;
         }
      }
   ...
   private void getPropertiesFromZone() {
      if (this.getObjectIndex() != -1) {
         ...
         if (var1 != null && var1.mannequinZones != null) {
            ...
            IsoMannequin.MannequinZone var3 = null;

            for(int var4 = 0; var4 < var2.size(); ++var4) {
               var3 = (IsoMannequin.MannequinZone)var2.get(var4);
   ...
   private void syncModel() {
      ...
      switch(var1.hashCode()) {
      case 133253487:
         if (var1.equals("MaleBody")) {
            var2 = 1;
         }
         break;
      case 1328258862:
         if (var1.equals("FemaleBody")) {
            var2 = 0;
         }
      }
      ...
      if (this.bAnimate) {
         if (this.animatedModel == null) {
            ...
            for(var3 = 0; var3 < this.drawers.length; ++var3) {
               this.drawers[var3] = new IsoMannequin.Drawer();
            }
         }
