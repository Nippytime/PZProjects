...
public class IsoWaveSignal extends IsoObject implements WaveSignalDevice, ChatElementOwner, Talker {
   ...
   public void Say(String var1) {
      this.AddDeviceText(var1, 1.0F, 1.0F, 1.0F, (String)null, (String)null, -1, false);
   }
   ...
   public void AddDeviceText(String var1, int var2, int var3, int var4, String var5, String var6, int var7) {
      this.AddDeviceText(var1, (float)var2 / 255.0F, (float)var3 / 255.0F, (float)var4 / 255.0F, var5, var6, var7, true);
   }

   public void AddDeviceText(String var1, int var2, int var3, int var4, String var5, String var6, int var7, boolean var8) {
      this.AddDeviceText(var1, (float)var2 / 255.0F, (float)var3 / 255.0F, (float)var4 / 255.0F, var5, var6, var7, var8);
   }
