...
public final class IsoMarkers {
      ...
      if (IsoCamera.frameState.playerIndex == 0) {
         if (this.circlemarkers.size() != 0) {
            ...
            for(var1 = this.circlemarkers.size() - 1; var1 >= 0; --var1) {
               if (((IsoMarkers.CircleIsoMarker)this.circlemarkers.get(var1)).isRemoved()) {
                  this.circlemarkers.remove(var1);
               }
            }

            for(var1 = 0; var1 < this.circlemarkers.size(); ++var1) {
               IsoMarkers.CircleIsoMarker var2 = (IsoMarkers.CircleIsoMarker)this.circlemarkers.get(var1);
               if (var2.alphaInc) {
                  var2.alpha += GameTime.getInstance().getMultiplier() * var2.fadeSpeed;
                  if (var2.alpha > var2.alphaMax) {
                     var2.alphaInc = false;
   ...
   public boolean removeCircleIsoMarker(IsoMarkers.CircleIsoMarker var1) {
   ...
   public boolean removeCircleIsoMarker(int var1) {
      for(int var2 = this.circlemarkers.size() - 1; var2 >= 0; --var2) {
         if (((IsoMarkers.CircleIsoMarker)this.circlemarkers.get(var2)).getID() == var1) {
            ((IsoMarkers.CircleIsoMarker)this.circlemarkers.get(var2)).remove();
   ...
   public IsoMarkers.CircleIsoMarker getCircleIsoMarker(int var1) {
      for(int var2 = 0; var2 < this.circlemarkers.size(); ++var2) {
         if (((IsoMarkers.CircleIsoMarker)this.circlemarkers.get(var2)).getID() == var1) {
            return (IsoMarkers.CircleIsoMarker)this.circlemarkers.get(var2);
         }
      }
   ...
   public IsoMarkers.CircleIsoMarker addCircleIsoMarker(IsoGridSquare var1, float var2, float var3, float var4, float var5) {
      if (GameServer.bServer) {
         return null;
      } else {
         IsoMarkers.CircleIsoMarker var6 = new IsoMarkers.CircleIsoMarker();
      ...
      if (!GameServer.bServer && this.circlemarkers.size() != 0) {
         ...
         if (var4 != null) {
            for(int var5 = 0; var5 < this.circlemarkers.size(); ++var5) {
               IsoMarkers.CircleIsoMarker var6 = (IsoMarkers.CircleIsoMarker)this.circlemarkers.get(var5);
               if (var6.z == (float)var2 && var6.z == var4.getZ() && var6.active) {
