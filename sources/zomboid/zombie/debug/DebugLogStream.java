...
public final class DebugLogStream extends PrintStream {
   ...
   public void noise(String var1, Object var2, Object var3, Object var4, Object var5, Object var6, Object var7) {
      if (Core.bDebug && this.m_formatter.isLogSeverityEnabled(LogSeverity.Debug)) {
         String var8 = generateCallerPrefix();
         String var9 = this.m_formatter.format(LogSeverity.Debug, "DEBUG: ", StringUtils.leftJustify(var8, 36) + "> ", var1, var2, var3, var4, var5, var6, var7);
         if (var9 != null) {
            this.m_wrappedStream.println(var9);
         }
      }
   ...
   public void trace(String var1, Object var2, Object var3, Object var4, Object var5, Object var6, Object var7) {
      if (this.m_formatter.isLogSeverityEnabled(LogSeverity.Trace)) {
         String var8 = generateCallerPrefix();
         String var9 = this.m_formatter.format(LogSeverity.Trace, "TRACE: ", StringUtils.leftJustify(var8, 36) + "> ", var1, var2, var3, var4, var5, var6, var7);
         if (var9 != null) {
            this.m_wrappedStream.println(var9);
         }
      }
