...
public final class LineDrawer {
   ...
   public static void DrawIsoRect(float var0, float var1, float var2, float var3, int var4, int var5, float var6, float var7, float var8) {
      ...
      float var9 = IsoUtils.XToScreenExact(var0, var1, (float)var4, 0);
      float var10 = IsoUtils.YToScreenExact(var0, var1, (float)var4, 0);
      float var11 = IsoUtils.XToScreenExact(var0 + var2, var1, (float)var4, 0);
      float var12 = IsoUtils.YToScreenExact(var0 + var2, var1, (float)var4, 0);
      float var13 = IsoUtils.XToScreenExact(var0 + var2, var1 + var3, (float)var4, 0);
      float var14 = IsoUtils.YToScreenExact(var0 + var2, var1 + var3, (float)var4, 0);
      float var15 = IsoUtils.XToScreenExact(var0, var1 + var3, (float)var4, 0);
      float var16 = IsoUtils.YToScreenExact(var0, var1 + var3, (float)var4, 0);
      float var17 = (float)(-var5 * Core.TileScale);
      var10 += var17;
      var12 += var17;
      var14 += var17;
      var16 += var17;
   ...
   public static void addRectYOffset(float var0, float var1, float var2, float var3, float var4, int var5, float var6, float var7, float var8) {
      LineDrawer.DrawableLine var9 = pool.isEmpty() ? new LineDrawer.DrawableLine() : (LineDrawer.DrawableLine)pool.pop();
      lines.add(var9.init(var0, var1, var2, var0 + var3, var1 + var4, var2, var6, var7, var8, (String)null, false));
   ...
   public static void render() {
      for(int var0 = 0; var0 < lines.size(); ++var0) {
         ...
         if (!var1.bLine) {
            DrawIsoRect(var1.xstart, var1.ystart, var1.xend - var1.xstart, var1.yend - var1.ystart, (int)var1.zstart, var1.yPixelOffset, var1.red, var1.green, var1.blue);
         } else {
