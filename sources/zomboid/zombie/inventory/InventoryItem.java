...
public class InventoryItem {
   ...
   public void DoTooltip(ObjectTooltip var1) {
      ...
      if (!(this instanceof HandWeapon) && this.getAmmoType() != null) {
         var16 = var15.addItem();
         var16.setLabel(Translator.getText("ContextMenu_AmmoType") + ":", 1.0F, 1.0F, 0.8F, 1.0F);
         String var20 = InventoryItemFactory.CreateItem(this.getAmmoType()).getDisplayName();
         var16.setValue(Translator.getText(var20), 1.0F, 1.0F, 1.0F, 1.0F);
      }

      if (this.gunType != null) {
         Item var21 = ScriptManager.instance.FindItem(this.getGunType());
         if (var21 == null) {
            ScriptManager var10000 = ScriptManager.instance;
            var10001 = this.getModule();
            var21 = var10000.FindItem(var10001 + "." + this.ammoType);
         }

         if (var21 != null) {
            var16 = var15.addItem();
            var16.setLabel(Translator.getText("ContextMenu_GunType") + ":", 1.0F, 1.0F, 0.8F, 1.0F);
            var16.setValue(var21.getDisplayName(), 1.0F, 1.0F, 1.0F, 1.0F);
         }
      }
      ...
      if (Core.bDebug && DebugOptions.instance.TooltipInfo.getValue()) {
         ...
         ClothingItem var22 = this.getClothingItem();
         if (var22 != null) {
            var16 = var15.addItem();
      ...
      if (this instanceof DrainableComboItem) {
         ...
         var11 = new ColorInfo();
         Core.getInstance().getBadHighlitedColor().interp(Core.getInstance().getGoodHighlitedColor(), var18, var11);
         var16.setProgress(var18, var11.getR(), var11.getG(), var11.getB(), 1.0F);
      }
      ...
      if (this.isTaintedWater() && SandboxOptions.instance.EnableTaintedWaterText.getValue()) {
         ...
         if (this.isCookable()) {
            ...
            var16.setLabel(Translator.getText("Tooltip_item_TaintedWater_Plastic"), 1.0F, 0.5F, 0.5F, 1.0F);
         }
      }
      ...
      if (this.isWet()) {
         ...
         var11 = new ColorInfo();
         Core.getInstance().getGoodHighlitedColor().interp(Core.getInstance().getBadHighlitedColor(), var18, var11);
         var16.setProgress(var18, var11.getR(), var11.getG(), var11.getB(), 1.0F);
      }
      ...
      if (this.isRecordedMedia()) {
         MediaData var23 = this.getMediaData();
         if (var23 != null) {
            if (var23.getTranslatedTitle() != null) {
               var16 = var15.addItem();
               var16.setLabel(Translator.getText("Tooltip_media_title") + ":", 1.0F, 1.0F, 0.8F, 1.0F);
               var16.setValue(var23.getTranslatedTitle(), 1.0F, 1.0F, 1.0F, 1.0F);
               if (var23.getTranslatedSubTitle() != null) {
                  var16 = var15.addItem();
                  var16.setLabel("", 1.0F, 1.0F, 0.8F, 1.0F);
                  var16.setValue(var23.getTranslatedSubTitle(), 1.0F, 1.0F, 1.0F, 1.0F);
               }
            }

            if (var23.getTranslatedAuthor() != null) {
               var16 = var15.addItem();
               var16.setLabel(Translator.getText("Tooltip_media_author") + ":", 1.0F, 1.0F, 0.8F, 1.0F);
               var16.setValue(var23.getTranslatedAuthor(), 1.0F, 1.0F, 1.0F, 1.0F);
            }
         }
      }
      ...
      if (Core.getInstance().getOptionShowItemModInfo() && !this.isVanilla()) {
         var16 = var15.addItem();
         Color var24 = Colors.CornFlowerBlue;
         var16.setLabel("Mod: " + this.getModName(), var24.r, var24.g, var24.b, 1.0F);
         ItemInfo var19 = WorldDictionary.getItemInfoFromID(this.registry_id);
         if (var19 != null && var19.getModOverrides() != null) {
            var16 = var15.addItem();
            float var12 = 0.5F;
            if (var19.getModOverrides().size() == 1) {
               var16.setLabel("This item overrides: " + WorldDictionary.getModNameFromID((String)var19.getModOverrides().get(0)), var12, var12, var12, 1.0F);
            } else {
               var16.setLabel("This item overrides:", var12, var12, var12, 1.0F);

               for(int var13 = 0; var13 < var19.getModOverrides().size(); ++var13) {
                  var16 = var15.addItem();
                  var16.setLabel(" - " + WorldDictionary.getModNameFromID((String)var19.getModOverrides().get(var13)), var12, var12, var12, 1.0F);
               }
            }
         }
      }
   ...
   public void initialiseItem() {
      ...
      if (this.getLuaCreate() != null) {
         ...
         if (var1 != null) {
            LuaManager.caller.protectedCallVoid(LuaManager.thread, var1, (Object)this);
         }
      }
