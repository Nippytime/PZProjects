      ...
      for(int var10 = 0; (float)var10 < var0.rolls; ++var10) {
         ...
         for(int var12 = 0; var12 < var11.length; ++var12) {
            ...
            if ((float)Rand.Next(10000) <= var14 * 100.0F * var15 + var2 * 10.0F) {
               ...
               String var22 = var16.getScriptItem().getRecordedMediaCat();
               if (var22 != null) {
                  RecordedMedia var23 = ZomboidRadio.getInstance().getRecordedMedia();
                  MediaData var19 = var23.getRandomFromCategory(var22);
                  if (var19 == null) {
                     var1.Remove(var16);
                     if ("Home-VHS".equalsIgnoreCase(var22)) {
                        var19 = var23.getRandomFromCategory("Retail-VHS");
                        if (var19 == null) {
                           return;
                        }
               ...
               if (!var24 && Rand.Next(100) < 40 && var16 instanceof DrainableComboItem) {
                  float var25 = 1.0F / ((DrainableComboItem)var16).getUseDelta();
                  ((DrainableComboItem)var16).setUsedDelta(Rand.Next(1.0F, var25 - 1.0F) * ((DrainableComboItem)var16).getUseDelta());
               }

               if (!var24 && var16 instanceof HandWeapon && Rand.Next(100) < 40) {
               ...
               if (var16 instanceof HandWeapon && !var0.dontSpawnAmmo && Rand.Next(100) < 90) {
                  ...
                  if (!StringUtils.isNullOrEmpty(var20.getAmmoBox()) && Rand.Next(100) < var26) {
               ...
               if (var16 instanceof InventoryContainer && containers.containsKey(var16.getType())) {
                  ItemPickerJava.ItemPickerContainer var27 = (ItemPickerJava.ItemPickerContainer)containers.get(var16.getType());
                  if (var4 && Rand.Next(var27.fillRand) == 0) {
