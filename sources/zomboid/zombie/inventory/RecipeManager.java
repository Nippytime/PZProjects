...
public final class RecipeManager {
   ...
   public static boolean isAllItemsUsableRotten(Recipe var0, IsoGameCharacter var1, InventoryItem var2, ArrayList var3) {
   ...
   private static final class RMRecipe {
      ...
      void getItemsFromContainer(IsoGameCharacter var1, ItemContainer var2, InventoryItem var3) {
         for(int var4 = 0; var4 < var2.getItems().size(); ++var4) {
            ...
            if ((var3 != null && var3 == var5 || !var1.isEquippedClothing(var5) || this.isKeep(var5.getFullType())) && (!this.recipe.InSameInventory || this.isKeep(var5.getFullType()) || var3 == null || var2 == var3.getContainer())) {
      ...
      void getAvailableItems(RecipeManager.SourceItems var1, boolean var2) {
         ...
         if (var2) {
            for(var3 = 0; var3 < this.itemLists.size(); ++var3) {
               RecipeManager.RMRecipeItemList var7 = (RecipeManager.RMRecipeItemList)this.itemLists.get(var3);
               var7.getAvailableItems(var1, var2);
            }
            ...
            for(int var4 = 0; var4 < this.itemLists.size(); ++var4) {
               ...
               if (var5.hasItems()) {
                  InventoryItem var6 = ((RecipeManager.RMRecipeItem)var5.items.get(0)).item;
