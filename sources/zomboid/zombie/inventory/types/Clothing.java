...
public class Clothing extends InventoryItem {
   ...
   public void DoTooltip(ObjectTooltip var1, ObjectTooltip.Layout var2) {
      ...
      int var15;
      for(var15 = 0; var15 < BloodBodyPartType.MAX.index(); ++var15) {
      ...
      if (!this.isEquipped() && var1.getCharacter() != null) {
         ...
         for(int var19 = 0; var19 < var18.size(); ++var19) {
            ...
            if (this.getBodyLocation().equals(var20.getLocation()) || var18.getBodyLocationGroup().isExclusive(this.getBodyLocation(), var20.getLocation())) {
               var22 += ((Clothing)var20.getItem()).getBiteDefense();
               var16 += ((Clothing)var20.getItem()).getScratchDefense();
               var17 += ((Clothing)var20.getItem()).getBulletDefense();
            }
         }

         float var23 = this.getBiteDefense();
         if (var23 != var22) {
            var3 = var2.addItem();
            if (var23 > 0.0F || var22 > 0.0F) {
               var3.setLabel(Translator.getText("Tooltip_BiteDefense") + ":", 1.0F, 1.0F, 0.8F, 1.0F);
               if (var23 > var22) {
                  var3.setValue((int)var23 + " (+" + (int)(var23 - var22) + ")", 0.0F, 1.0F, 0.0F, 1.0F);
               } else {
                  var3.setValue((int)var23 + " (-" + (int)(var22 - var23) + ")", 1.0F, 0.0F, 0.0F, 1.0F);
               }
            }
         ...
         float var24 = this.getScratchDefense();
         if (var24 != var16) {
            var3 = var2.addItem();
            if (var24 > 0.0F || var16 > 0.0F) {
               var3.setLabel(Translator.getText("Tooltip_ScratchDefense") + ":", 1.0F, 1.0F, 0.8F, 1.0F);
               if (var24 > var16) {
                  var3.setValue((int)var24 + " (+" + (int)(var24 - var16) + ")", 0.0F, 1.0F, 0.0F, 1.0F);
               } else {
                  var3.setValue((int)var24 + " (-" + (int)(var16 - var24) + ")", 1.0F, 0.0F, 0.0F, 1.0F);
               }
            }
         ...
         if (var21 != var17) {
            ...
            if (var21 > 0.0F || var17 > 0.0F) {
               ...
               if (var21 > var17) {
                  var3.setValue((int)var21 + " (+" + (int)(var21 - var17) + ")", 0.0F, 1.0F, 0.0F, 1.0F);
               } else {
                  var3.setValue((int)var21 + " (-" + (int)(var17 - var21) + ")", 1.0F, 0.0F, 0.0F, 1.0F);
               }
            }
         ...
         if (this.container == null) {
            ...
            if (var5.getCurrentSquare() == null) {
               ...
               if (ClimateManager.getInstance().isRaining()) {
                  if (!this.isEquipped()) {
                     return Clothing.WetDryState.Dryer;
                  } else if (var5.isAsleep() && var5.getBed() != null && "Tent".equals(var5.getBed().getName())) {
                     return Clothing.WetDryState.Dryer;
                  } else {
   ...
   public int getCondLossPerHole() {
      ...
      int var1 = PZMath.max(1, this.getConditionMax() / var2);
      return var1;
   }
