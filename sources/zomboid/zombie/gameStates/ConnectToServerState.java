   ...
   private void WorkshopInit() {
      ...
      if (this.workshopItems.isEmpty()) {
         ...
         for(int var10 = 0; var10 < this.workshopItems.size(); ++var10) {
            ConnectToServerState.WorkshopItem var5 = (ConnectToServerState.WorkshopItem)this.workshopItems.get(var10);
            var9[var10] = var5.ID;
         }
   ...
   private void WorkshopConfirm() {
      ...
      if (this.confirmItems.isEmpty()) {
         ...
         for(int var6 = 0; var6 < this.workshopItems.size(); ++var6) {
            ConnectToServerState.WorkshopItem var8 = (ConnectToServerState.WorkshopItem)this.workshopItems.get(var6);
      ...
      if (!this.query.isCompleted()) {
         ...
         while(true) {
            while(var1.hasNext()) {
               ...
               while(var3.hasNext()) {
                  ConnectToServerState.WorkshopItem var4 = (ConnectToServerState.WorkshopItem)var3.next();
