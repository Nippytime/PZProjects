               ...
               if (playerWrongIP) {
                  ...
                  if (GameClient.bClient) {
                     ...
                     if (GameClient.connection.getConnectionType() == UdpConnection.ConnectionType.Steam) {
                        ...
                        TextManager.instance.DrawStringCentre(UIFont.Medium, (double)(Core.getInstance().getScreenWidth() / 2), (double)(Core.getInstance().getScreenHeight() - 32), this.text, 0.1D, 0.1D, 0.1D, 1.0D);
                     }
