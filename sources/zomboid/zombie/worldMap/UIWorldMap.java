...
public class UIWorldMap extends UIElement {
      ...
      if (this.isVisible()) {
         if (this.Parent == null || this.Parent.getMaxDrawHeight() == -1.0D || !(this.Parent.getMaxDrawHeight() <= this.getY())) {
            ...
            if (Core.bDebug && this.m_renderer.getBoolean("DebugInfo")) {
               ...
               double var14 = 1.0D;
               byte var16 = 0;
               this.DrawText("SQUARE = " + (int)var6 + "," + (int)var7, 0.0D, (double)var16, var8, var10, var12, var14);
               var31 = var16 + var5;
               this.DrawText("CELL = " + (int)(var6 / 300.0F) + "," + (int)(var7 / 300.0F), 0.0D, (double)var5, var8, var10, var12, var14);
               var31 += var5;
               this.DrawText("ZOOM = " + this.m_renderer.getDisplayZoomF(), 0.0D, (double)var31, var8, var10, var12, var14);
               var31 += var5;
               WorldMapRenderer var10001 = this.m_renderer;
               this.DrawText("SCALE = " + var10001.getWorldScale(this.m_renderer.getZoomF()), 0.0D, (double)var31, var8, var10, var12, var14);
               int var10000 = var31 + var5;
            }
            ...
            if (Core.bDebug && DebugOptions.instance.UIRenderOutline.getValue()) {
               ...
               var8 = this.isMouseOver() ? 0.0D : 1.0D;
               this.DrawTextureScaledColor((Texture)null, var23, var24, 1.0D, (double)this.height, var8, 1.0D, 1.0D, 0.5D);
               this.DrawTextureScaledColor((Texture)null, var23 + 1.0D, var24, (double)this.width - 2.0D, 1.0D, var8, 1.0D, 1.0D, 0.5D);
               this.DrawTextureScaledColor((Texture)null, var23 + (double)this.width - 1.0D, var24, 1.0D, (double)this.height, var8, 1.0D, 1.0D, 0.5D);
               this.DrawTextureScaledColor((Texture)null, var23 + 1.0D, var24 + (double)this.height - 1.0D, (double)this.width - 2.0D, 1.0D, var8, 1.0D, 1.0D, 0.5D);
            }
            ...
            if (Core.bDebug && this.m_renderer.getBoolean("HitTest")) {
               ...
               if (!s_tempFeatures.isEmpty()) {
                  ...
                  for(int var30 = 0; var30 < var13.numPoints(); ++var30) {
                     ...
                     var31 = var13.getY(var30);
                     int var17 = var13.getX((var30 + 1) % var13.numPoints());
                     int var18 = var13.getY((var30 + 1) % var13.numPoints());
                     float var19 = this.m_APIv1.worldToUIX((float)(var27 + var15), (float)(var28 + var31));
                     float var20 = this.m_APIv1.worldToUIY((float)(var27 + var15), (float)(var28 + var31));
   ...
   private void renderPlayer(float var1, float var2) {
      ...
      this.DrawTextureScaledColor((Texture)null, (double)var6 - 3.0D, (double)var7 - 3.0D, 6.0D, 6.0D, 1.0D, 0.0D, 0.0D, 1.0D);
   }
   ...
   private void renderPlayerName(float var1, float var2, String var3) {
      if (this.m_renderer.getBoolean("PlayerNames")) {
         if (!StringUtils.isNullOrWhitespace(var3)) {
            ...
            this.DrawTextureScaledColor((Texture)null, (double)var7 - (double)var9 / 2.0D, (double)var8 + 4.0D, (double)var9, (double)var11, 0.5D, 0.5D, 0.5D, 0.5D);
            this.DrawTextCentre(var3, (double)var7, (double)(var8 + 4.0F) + (double)(var11 - var10) / 2.0D, 0.0D, 0.0D, 0.0D, 1.0D);
         }
      }
   }
