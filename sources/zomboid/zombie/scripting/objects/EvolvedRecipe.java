      ...
      if (this.itemsList.get(var2.getType()) != null && ((ItemRecipe)this.itemsList.get(var2.getType())).use > -1) {
         if (!(var2 instanceof Food)) {
            ...
            if (var1 instanceof Food) {
               ...
               if ((double)var16.getHungerChange() >= -0.02D || var9) {
                  var2.Use();
               }
               ...
               if (var16.getPoisonPower() > 0) {
                  var16.setPoisonPower((int)((double)((float)var16.getPoisonPower() - (float)var16.getPoisonPower() * var12) + 0.999D));
                  ((Food)var1).setPoisonPower((int)((double)((float)var16.getPoisonPower() * var12) + 0.999D));
               }
            }
         }
