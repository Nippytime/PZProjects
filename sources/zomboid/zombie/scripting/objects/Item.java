...
public final class Item extends BaseScriptObject {
   ...
   private HashMap ReplaceTypesMap = null;
   ...
   private HashMap soundParameterMap = null;
   ...
   public InventoryItem InstanceItem(String var1) {
      ...
      if (this.type == Item.Type.Literature) {
         ...
         if (this.type == Item.Type.AlarmClockClothing) {
            ...
            DrainableComboItem var15 = (DrainableComboItem)var2;
            var15.setUseWhileEquiped(this.UseWhileEquipped);
            var15.setUseWhileUnequiped(this.UseWhileUnequipped);
            var15.setTicksPerEquipUse(this.TicksPerEquipUse);
            var15.setUseDelta(this.UseDelta);
            var15.setReplaceOnDeplete(this.ReplaceOnDeplete);
            var15.setIsCookable(this.IsCookable);
            var15.setReplaceOnCooked(this.ReplaceOnCooked);
            var15.setMinutesToCook((float)this.MinutesToCook);
            var15.setOnCooked(this.OnCooked);
            var15.setRainFactor(this.rainFactor);
            var15.setCanConsolidate(!this.cantBeConsolided);
            var15.setWeightEmpty(this.WeightEmpty);
         } else if (this.type == Item.Type.Radio) {
            var2 = new Radio(this.module.name, this.DisplayName, this.name, "Item_" + this.Icon);
            Radio var16 = (Radio)var2;
            DeviceData var17 = var16.getDeviceData();
            if (var17 != null) {
               if (this.DisplayName != null) {
                  var17.setDeviceName(this.DisplayName);
               }

               var17.setIsTwoWay(this.twoWay);
               var17.setTransmitRange(this.transmitRange);
               var17.setMicRange(this.micRange);
               var17.setBaseVolumeRange(this.baseVolumeRange);
               var17.setIsPortable(this.isPortable);
               var17.setIsTelevision(this.isTelevision);
               var17.setMinChannelRange(this.minChannel);
               var17.setMaxChannelRange(this.maxChannel);
               var17.setIsBatteryPowered(this.usesBattery);
               var17.setIsHighTier(this.isHighTier);
               var17.setUseDelta(this.UseDelta);
               var17.setMediaType(this.acceptMediaType);
               var17.setNoTransmit(this.noTransmit);
               var17.generatePresets();
               var17.setRandomChannel();
            }

            if (!StringUtils.isNullOrWhitespace(this.worldObjectSprite) && !var16.ReadFromWorldSprite(this.worldObjectSprite)) {
            ...
            Moveable var18 = (Moveable)var2;
            var18.ReadFromWorldSprite(this.worldObjectSprite);
            this.ActualWeight = var18.getActualWeight();
         } else if (this.type == Item.Type.Map) {
            MapItem var19 = new MapItem(this.module.name, this.DisplayName, this.name, this);
            if (StringUtils.isNullOrWhitespace(this.map)) {
               var19.setMapID(MapDefinitions.getInstance().pickRandom());
            } else {
               var19.setMapID(this.map);
            }
      ...
      if ((var14 == GameWindow.GameThread || var14 == GameLoadingState.loader || var14 == GameServer.MainThread) && !((InventoryItem)var2).isInitialised()) {
         ((InventoryItem)var2).initialiseItem();
      }
               ...
               if (var3.trim().equalsIgnoreCase("Palettes")) {
                  ...
                  if (var3.trim().equalsIgnoreCase("Icon")) {
                     ...
                     if (this.type == Item.Type.Food) {
                        ...
                        var18 = this.WorldTextureName.replace(".png", "Rotten.png");
                        if (var17 == null) {
                     ...
                     String var20;
                     if (var3.trim().equalsIgnoreCase("ReplaceOnUseOn")) {
                        this.ReplaceOnUseOn = var4;
                        if (var4.contains("-")) {
                           var5 = var4.split("-");
                           var18 = var5[0].trim();
                           var20 = var5[1].trim();
                           if (!var18.isEmpty() && !var20.isEmpty()) {
                              if (this.ReplaceTypesMap == null) {
                                 this.ReplaceTypesMap = new HashMap();
                              }

                              this.ReplaceTypesMap.put(var18, var20);
                           }
                        }
                     } else {
                        String var11;
                        int var21;
                        if (var3.trim().equalsIgnoreCase("ReplaceTypes")) {
                           ...
                           if (var5.length >= 2 && var5.length <= 4) {
                              ModelWeaponPart var23 = null;

                              for(var21 = 0; var21 < this.modelWeaponPart.size(); ++var21) {
                                 ModelWeaponPart var25 = (ModelWeaponPart)this.modelWeaponPart.get(var21);
                                 if (var25.partType.equals(var5[0])) {
                                    var23 = var25;
                                    break;
                                 }
                              }
                              ...
                              if (var23 == null) {
                                 var23 = new ModelWeaponPart();
                              }

                              var23.partType = var5[0];
                              var23.modelName = var5[1];
                              var23.attachmentNameSelf = var5.length > 2 ? var5[2] : null;
                              var23.attachmentParent = var5.length > 3 ? var5[3] : null;
                              if (!var23.partType.contains(".")) {
                                 var23.partType = this.module.name + "." + var23.partType;
                              }

                              if (!var23.modelName.contains(".")) {
                                 var23.modelName = this.module.name + "." + var23.modelName;
                              }

                              if ("none".equalsIgnoreCase(var23.attachmentNameSelf)) {
                                 var23.attachmentNameSelf = null;
                              }

                              if ("none".equalsIgnoreCase(var23.attachmentParent)) {
                                 var23.attachmentParent = null;
                              }

                              this.modelWeaponPart.add(var23);
                           }
                           ...
                           var5 = var4.split("\\s+");
                           if (var5.length == 2 && !var5[0].trim().isEmpty()) {
                              if (this.SoundMap == null) {
                                 this.SoundMap = new HashMap();
                              }

                              this.SoundMap.put(var5[0].trim(), var5[1].trim());
                           }
                           ...
                           for(var6 = 0; var6 < var5.length; ++var6) {
                              ...
                              if (!var20.contains(":")) {
                                 ...
                                 var11 = var20.split(":")[1];
                                 if (!var11.contains("|")) {
                                    var24 = Integer.parseInt(var20.split(":")[1]);
                                 } else {
                                    String[] var29 = var11.split("\\|");

                                    for(int var13 = 0; var13 < var29.length; ++var13) {
                                       if ("Cooked".equals(var29[var13])) {
                                          var26 = true;
                                       }
                                    }

                                    var24 = Integer.parseInt(var29[0]);
                                 }
                              }

                              ItemRecipe var28 = new ItemRecipe(this.name, this.module.getName(), var24);
                              EvolvedRecipe var30 = null;
                              Iterator var31 = ((ScriptModule)ScriptManager.instance.ModuleMap.get("Base")).EvolvedRecipeMap.iterator();

                              while(var31.hasNext()) {
                                 EvolvedRecipe var14 = (EvolvedRecipe)var31.next();
                              ...
                              var28.cooked = var26;
                              if (var30 == null) {
                                 var30 = new EvolvedRecipe(var8);
                                 ((ScriptModule)ScriptManager.instance.ModuleMap.get("Base")).EvolvedRecipeMap.add(var30);
                              }

                              var30.itemsList.put(this.name, var28);
                           }
                           ...
                           this.soundParameterMap.put(var5[0].trim(), var5[1].trim());
                        } else {
   ...
   public void resolveItemTypes() {
      ...
      if (this.ReplaceTypesMap != null) {
         ...
         while(var4.hasNext()) {
            ...
            this.ReplaceTypesMap.replace(var2, ScriptManager.instance.resolveItemType(this.module, var3));
         }
      }
